...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class FilterBouncedRecipientsResult : IEquatable<FilterBouncedRecipientsResult>, IValidatableObject
    {
        ...
        public FilterBouncedRecipientsResult(List<string> filteredRecipients = default(List<string>))
        {
            ...
            this.FilteredRecipients = filteredRecipients ?? throw new ArgumentNullException("filteredRecipients is a required property for FilterBouncedRecipientsResult and cannot be null");
        }

        /// <summary>
        /// Gets or Sets FilteredRecipients
        /// </summary>
        [DataMember(Name = "filteredRecipients", IsRequired = true, EmitDefaultValue = false)]
