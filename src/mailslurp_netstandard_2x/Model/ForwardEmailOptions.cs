...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ForwardEmailOptions : IEquatable<ForwardEmailOptions>, IValidatableObject
    {
        ...
        public ForwardEmailOptions(List<string> bcc = default(List<string>), List<string> cc = default(List<string>), string from = default(string), string subject = default(string), List<string> to = default(List<string>), bool useInboxName = default(bool))
        {
            this.Bcc = bcc;
            this.Cc = cc;
            this.From = from;
