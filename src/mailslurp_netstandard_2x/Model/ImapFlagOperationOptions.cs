...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ImapFlagOperationOptions : IEquatable<ImapFlagOperationOptions>, IValidatableObject
    {
        ...
        /// </summary>
        [DataMember(Name = "flagOperation", IsRequired = true, EmitDefaultValue = false)]
        ...
        public ImapFlagOperationOptions(FlagOperationEnum flagOperation = default(FlagOperationEnum), List<string> flags = default(List<string>))
        {
            ...
            this.Flags = flags ?? throw new ArgumentNullException("flags is a required property for ImapFlagOperationOptions and cannot be null");
        }

        /// <summary>
        /// Gets or Sets Flags
        /// </summary>
        [DataMember(Name = "flags", IsRequired = true, EmitDefaultValue = false)]
