...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageSentEmailProjection : IEquatable<PageSentEmailProjection>, IValidatableObject
    {
        ...
        public PageSentEmailProjection(List<SentEmailProjection> content = default(List<SentEmailProjection>), PageableObject pageable = default(PageableObject), long total = default(long), int size = default(int), int number = default(int), int numberOfElements = default(int), int totalPages = default(int), long totalElements = default(long), bool last = default(bool), Sort sort = default(Sort), bool first = default(bool), bool empty = default(bool))
        {
