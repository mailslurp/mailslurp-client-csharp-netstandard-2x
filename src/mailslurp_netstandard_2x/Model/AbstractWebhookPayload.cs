...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class AbstractWebhookPayload : IEquatable<AbstractWebhookPayload>, IValidatableObject
    {
        ...
        public AbstractWebhookPayload(string webhookName = default(string), EventNameEnum eventName = default(EventNameEnum), Guid webhookId = default(Guid), string messageId = default(string))
        {
