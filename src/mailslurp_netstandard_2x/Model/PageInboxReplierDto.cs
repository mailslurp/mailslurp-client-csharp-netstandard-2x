...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageInboxReplierDto : IEquatable<PageInboxReplierDto>, IValidatableObject
    {
        ...
        public PageInboxReplierDto(List<InboxReplierDto> content = default(List<InboxReplierDto>), PageableObject pageable = default(PageableObject), long total = default(long), long totalElements = default(long), int totalPages = default(int), bool last = default(bool), int size = default(int), int number = default(int), Sort sort = default(Sort), int numberOfElements = default(int), bool first = default(bool), bool empty = default(bool))
        {
