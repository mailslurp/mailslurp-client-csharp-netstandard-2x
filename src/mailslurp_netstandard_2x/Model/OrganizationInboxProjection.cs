...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class OrganizationInboxProjection : IEquatable<OrganizationInboxProjection>, IValidatableObject
    {
        ...
        public OrganizationInboxProjection(DateTime createdAt = default(DateTime), string emailAddress = default(string), bool favourite = default(bool), Guid id = default(Guid), InboxTypeEnum? inboxType = default(InboxTypeEnum?), string name = default(string), bool readOnly = default(bool), List<string> tags = default(List<string>), bool teamAccess = default(bool))
        {
