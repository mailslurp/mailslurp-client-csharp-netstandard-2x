...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class AttachmentMetaData : IEquatable<AttachmentMetaData>, IValidatableObject
    {
        ...
        /// <param name="id">ID of attachment (required).</param>
        public AttachmentMetaData(string name = default(string), string contentType = default(string), long contentLength = default(long), string id = default(string))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for AttachmentMetaData and cannot be null");
            // to ensure "contentType" is required (not null)
            this.ContentType = contentType ?? throw new ArgumentNullException("contentType is a required property for AttachmentMetaData and cannot be null");
            this.ContentLength = contentLength;
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for AttachmentMetaData and cannot be null");
        }
