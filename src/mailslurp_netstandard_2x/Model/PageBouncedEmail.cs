...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageBouncedEmail : IEquatable<PageBouncedEmail>, IValidatableObject
    {
        ...
        public PageBouncedEmail(List<BounceProjection> content = default(List<BounceProjection>), PageableObject pageable = default(PageableObject), long total = default(long), bool last = default(bool), long totalElements = default(long), int totalPages = default(int), int size = default(int), int number = default(int), Sort sort = default(Sort), bool first = default(bool), int numberOfElements = default(int), bool empty = default(bool))
        {
