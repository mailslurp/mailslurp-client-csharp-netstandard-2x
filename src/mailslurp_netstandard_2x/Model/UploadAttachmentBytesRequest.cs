...
namespace mailslurp_netstandard_2x.Model
{
    ...
    /// </summary>
    [DataContract(Name = "uploadAttachmentBytes_request")]
    public partial class UploadAttachmentBytesRequest : IEquatable<UploadAttachmentBytesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UploadAttachmentBytesRequest" /> class.
        /// </summary>
        ...
        public UploadAttachmentBytesRequest(int _short = default(int), string _char = default(string), int _int = default(int), long _long = default(long), float _float = default(float), double _double = default(double), bool direct = default(bool), bool readOnly = default(bool))
        {
            this.Short = _short;
            this.Char = _char;
            this.Int = _int;
        ...
        {
            return this.Equals(input as UploadAttachmentBytesRequest);
        }

        /// <summary>
        /// Returns true if UploadAttachmentBytesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UploadAttachmentBytesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UploadAttachmentBytesRequest input)
        {
            if (input == null)
            {
                return false;
