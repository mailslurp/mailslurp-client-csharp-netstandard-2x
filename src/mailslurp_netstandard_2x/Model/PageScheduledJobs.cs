...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageScheduledJobs : IEquatable<PageScheduledJobs>, IValidatableObject
    {
        ...
        public PageScheduledJobs(List<ScheduledJob> content = default(List<ScheduledJob>), PageableObject pageable = default(PageableObject), long total = default(long), long totalElements = default(long), int totalPages = default(int), bool last = default(bool), int numberOfElements = default(int), bool first = default(bool), int size = default(int), int number = default(int), SortObject sort = default(SortObject), bool empty = default(bool))
        {
