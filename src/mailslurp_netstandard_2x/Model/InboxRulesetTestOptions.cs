...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class InboxRulesetTestOptions : IEquatable<InboxRulesetTestOptions>, IValidatableObject
    {
        ...
        public InboxRulesetTestOptions(string testTarget = default(string))
        {
            ...
            this.TestTarget = testTarget ?? throw new ArgumentNullException("testTarget is a required property for InboxRulesetTestOptions and cannot be null");
        }

        /// <summary>
        /// Gets or Sets TestTarget
        /// </summary>
        [DataMember(Name = "testTarget", IsRequired = true, EmitDefaultValue = false)]
