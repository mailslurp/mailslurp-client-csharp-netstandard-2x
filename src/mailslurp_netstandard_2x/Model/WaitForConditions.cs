...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class WaitForConditions : IEquatable<WaitForConditions>, IValidatableObject
    {
        ...
        public WaitForConditions(int count = default(int), CountTypeEnum? countType = default(CountTypeEnum?), Guid inboxId = default(Guid), List<MatchOption> matches = default(List<MatchOption>), DateTime since = default(DateTime), SortDirectionEnum? sortDirection = default(SortDirectionEnum?), long timeout = default(long), bool unreadOnly = default(bool))
        {
            this.Count = count;
