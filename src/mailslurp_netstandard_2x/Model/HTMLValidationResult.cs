...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class HTMLValidationResult : IEquatable<HTMLValidationResult>, IValidatableObject
    {
        ...
        public HTMLValidationResult(List<ValidationMessage> errors = default(List<ValidationMessage>), List<ValidationMessage> warnings = default(List<ValidationMessage>), bool valid = default(bool))
        {
            this.Errors = errors;
