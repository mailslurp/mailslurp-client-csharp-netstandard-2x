...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class InboxRulesetDto : IEquatable<InboxRulesetDto>, IValidatableObject
    {
        ...
        public InboxRulesetDto(ActionEnum action = default(ActionEnum), HandlerEnum handler = default(HandlerEnum), Guid id = default(Guid), Guid inboxId = default(Guid), ScopeEnum scope = default(ScopeEnum), string target = default(string))
        {
            this.Action = action;
