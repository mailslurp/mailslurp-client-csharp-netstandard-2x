...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageSentEmailWithQueueProjection : IEquatable<PageSentEmailWithQueueProjection>, IValidatableObject
    {
        ...
        public PageSentEmailWithQueueProjection(List<SendWithQueueResult> content = default(List<SendWithQueueResult>), PageableObject pageable = default(PageableObject), long total = default(long), int numberOfElements = default(int), long totalElements = default(long), int totalPages = default(int), int size = default(int), int number = default(int), bool last = default(bool), bool first = default(bool), SortObject sort = default(SortObject), bool empty = default(bool))
        {
            // to ensure "content" is required (not null)
            if (content == null)
            {
                throw new ArgumentNullException("content is a required property for PageSentEmailWithQueueProjection and cannot be null");
            }
