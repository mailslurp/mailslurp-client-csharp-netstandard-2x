...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageSentEmailWithQueueProjection : IEquatable<PageSentEmailWithQueueProjection>, IValidatableObject
    {
        ...
        public PageSentEmailWithQueueProjection(List<SendWithQueueResult> content = default(List<SendWithQueueResult>), PageableObject pageable = default(PageableObject), long total = default(long), int size = default(int), int number = default(int), int numberOfElements = default(int), long totalElements = default(long), int totalPages = default(int), bool last = default(bool), Sort sort = default(Sort), bool first = default(bool), bool empty = default(bool))
        {
