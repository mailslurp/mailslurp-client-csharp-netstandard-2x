...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ConnectorProjection : IEquatable<ConnectorProjection>, IValidatableObject
    {
        ...
        public ConnectorProjection(Guid inboxId = default(Guid), Guid userId = default(Guid), bool syncEnabled = default(bool), ConnectorTypeEnum connectorType = default(ConnectorTypeEnum), SyncScheduleTypeEnum syncScheduleType = default(SyncScheduleTypeEnum), int syncInterval = default(int), DateTime createdAt = default(DateTime), Guid id = default(Guid))
        {
