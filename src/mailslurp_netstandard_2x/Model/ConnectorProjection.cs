...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ConnectorProjection : IEquatable<ConnectorProjection>, IValidatableObject
    {
        ...
        public ConnectorProjection(Guid id = default(Guid), Guid userId = default(Guid), Guid inboxId = default(Guid), DateTime createdAt = default(DateTime), ConnectorTypeEnum connectorType = default(ConnectorTypeEnum), SyncScheduleTypeEnum syncScheduleType = default(SyncScheduleTypeEnum), int syncInterval = default(int), bool syncEnabled = default(bool))
        {
            this.UserId = userId;
