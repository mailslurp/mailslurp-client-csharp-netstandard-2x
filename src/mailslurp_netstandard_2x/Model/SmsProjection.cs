...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class SmsProjection : IEquatable<SmsProjection>, IValidatableObject
    {
        ...
        public SmsProjection(Guid id = default(Guid), string body = default(string), Guid userId = default(Guid), DateTime createdAt = default(DateTime), Guid phoneNumber = default(Guid), string fromNumber = default(string), bool read = default(bool))
        {
            this.Id = id;
            // to ensure "body" is required (not null)
            this.Body = body ?? throw new ArgumentNullException("body is a required property for SmsProjection and cannot be null");
            this.UserId = userId;
