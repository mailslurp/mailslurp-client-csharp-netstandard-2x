...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class SmsProjection : IEquatable<SmsProjection>, IValidatableObject
    {
        ...
        public SmsProjection(string body = default(string), Guid userId = default(Guid), DateTime createdAt = default(DateTime), Guid phoneNumber = default(Guid), string fromNumber = default(string), bool read = default(bool), Guid id = default(Guid))
        {
