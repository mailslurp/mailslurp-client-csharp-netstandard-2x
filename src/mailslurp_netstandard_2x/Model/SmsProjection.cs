...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class SmsProjection : IEquatable<SmsProjection>, IValidatableObject
    {
        ...
        public SmsProjection(Guid id = default(Guid), string body = default(string), Guid userId = default(Guid), Guid phoneNumber = default(Guid), DateTime createdAt = default(DateTime), string fromNumber = default(string), bool read = default(bool))
        {
            this.Id = id;
