...
namespace mailslurp_netstandard_2x.Model
{
    ...
    /// Bounce
    /// </summary>
    [DataContract(Name = "Bounce")]
    public partial class Bounce : IEquatable<Bounce>, IValidatableObject
    {
        /// <summary>
        ...
        public Bounce(string bounceMta = default(string), List<string> bounceRecipients = default(List<string>), string bounceSubType = default(string), string bounceType = default(string), DateTime createdAt = default(DateTime), Guid id = default(Guid), string notificationType = default(string), string sender = default(string), List<string> sentToRecipients = default(List<string>), DateTime updatedAt = default(DateTime), Guid userId = default(Guid))
        {
            this.CreatedAt = createdAt;
            // to ensure "notificationType" is required (not null)
            this.NotificationType = notificationType ?? throw new ArgumentNullException("notificationType is a required property for Bounce and cannot be null");
            // to ensure "sender" is required (not null)
            this.Sender = sender ?? throw new ArgumentNullException("sender is a required property for Bounce and cannot be null");
        ...
        {
            return this.Equals(input as Bounce);
        }

        /// <summary>
        /// Returns true if Bounce instances are equal
        /// </summary>
        /// <param name="input">Instance of Bounce to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Bounce input)
        {
            if (input == null)
                return false;
