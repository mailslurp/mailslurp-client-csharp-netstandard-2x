...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageContactProjection : IEquatable<PageContactProjection>, IValidatableObject
    {
        ...
        public PageContactProjection(List<ContactProjection> content = default(List<ContactProjection>), PageableObject pageable = default(PageableObject), long total = default(long), bool last = default(bool), long totalElements = default(long), int totalPages = default(int), int size = default(int), int number = default(int), Sort sort = default(Sort), bool first = default(bool), int numberOfElements = default(int), bool empty = default(bool))
        {
