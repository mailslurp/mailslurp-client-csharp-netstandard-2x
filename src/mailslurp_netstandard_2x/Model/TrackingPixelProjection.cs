...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class TrackingPixelProjection : IEquatable<TrackingPixelProjection>, IValidatableObject
    {
        ...
        public TrackingPixelProjection(string name = default(string), Guid id = default(Guid), DateTime createdAt = default(DateTime), Guid userId = default(Guid), Guid inboxId = default(Guid), string recipient = default(string), bool seen = default(bool), DateTime seenAt = default(DateTime), Guid sentEmailId = default(Guid))
        {
            this.Id = id;
