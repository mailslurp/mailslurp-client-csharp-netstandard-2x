...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class TrackingPixelProjection : IEquatable<TrackingPixelProjection>, IValidatableObject
    {
        ...
        public TrackingPixelProjection(DateTime createdAt = default(DateTime), Guid id = default(Guid), string name = default(string), bool seen = default(bool), Guid userId = default(Guid))
        {
