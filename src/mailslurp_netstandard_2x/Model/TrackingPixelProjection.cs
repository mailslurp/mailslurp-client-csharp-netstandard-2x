...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class TrackingPixelProjection : IEquatable<TrackingPixelProjection>, IValidatableObject
    {
        ...
        public TrackingPixelProjection(string name = default(string), Guid id = default(Guid), Guid userId = default(Guid), Guid inboxId = default(Guid), bool seen = default(bool), DateTime createdAt = default(DateTime), string recipient = default(string), DateTime seenAt = default(DateTime), Guid sentEmailId = default(Guid))
        {
            this.Id = id;
            this.UserId = userId;
            this.Seen = seen;
