...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class TrackingPixelProjection : IEquatable<TrackingPixelProjection>, IValidatableObject
    {
        ...
        public TrackingPixelProjection(DateTime createdAt = default(DateTime), Guid id = default(Guid), Guid inboxId = default(Guid), string name = default(string), string recipient = default(string), bool seen = default(bool), DateTime seenAt = default(DateTime), Guid sentEmailId = default(Guid), Guid userId = default(Guid))
        {
