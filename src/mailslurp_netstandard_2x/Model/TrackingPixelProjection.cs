...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class TrackingPixelProjection : IEquatable<TrackingPixelProjection>, IValidatableObject
    {
        ...
        public TrackingPixelProjection(DateTime createdAt = default(DateTime), Guid sentEmailId = default(Guid), Guid userId = default(Guid), Guid inboxId = default(Guid), string recipient = default(string), bool seen = default(bool), DateTime seenAt = default(DateTime), string name = default(string), Guid id = default(Guid))
        {
