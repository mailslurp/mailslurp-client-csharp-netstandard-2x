...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class TrackingPixelProjection : IEquatable<TrackingPixelProjection>, IValidatableObject
    {
        ...
        public TrackingPixelProjection(string name = default(string), Guid id = default(Guid), Guid inboxId = default(Guid), Guid userId = default(Guid), Guid sentEmailId = default(Guid), DateTime createdAt = default(DateTime), string recipient = default(string), bool seen = default(bool), DateTime seenAt = default(DateTime))
        {
            this.Id = id;
            this.UserId = userId;
