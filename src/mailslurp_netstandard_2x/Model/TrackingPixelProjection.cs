...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class TrackingPixelProjection : IEquatable<TrackingPixelProjection>, IValidatableObject
    {
        ...
        public TrackingPixelProjection(Guid inboxId = default(Guid), Guid userId = default(Guid), Guid sentEmailId = default(Guid), string recipient = default(string), bool seen = default(bool), DateTime seenAt = default(DateTime), DateTime createdAt = default(DateTime), string name = default(string), Guid id = default(Guid))
        {
            this.UserId = userId;
            this.Seen = seen;
