...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class InboxIdsResult : IEquatable<InboxIdsResult>, IValidatableObject
    {
        ...
        public InboxIdsResult(List<Guid> inboxIds = default(List<Guid>))
        {
            // to ensure "inboxIds" is required (not null)
            this.InboxIds = inboxIds ?? throw new ArgumentNullException("inboxIds is a required property for InboxIdsResult and cannot be null");
        }
