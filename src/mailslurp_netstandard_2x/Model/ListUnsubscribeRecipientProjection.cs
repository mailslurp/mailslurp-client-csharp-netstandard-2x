...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ListUnsubscribeRecipientProjection : IEquatable<ListUnsubscribeRecipientProjection>, IValidatableObject
    {
        ...
        public ListUnsubscribeRecipientProjection(string emailAddress = default(string), Guid? domainId = default(Guid?), DateTime createdAt = default(DateTime), Guid id = default(Guid))
        {
