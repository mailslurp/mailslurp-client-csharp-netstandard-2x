...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class WebhookDto : IEquatable<WebhookDto>, IValidatableObject
    {
        ...
        public WebhookDto(Guid id = default(Guid), Guid userId = default(Guid), bool basicAuth = default(bool), string name = default(string), Guid? phoneId = default(Guid?), Guid? inboxId = default(Guid?), string url = default(string), MethodEnum method = default(MethodEnum), string payloadJsonSchema = default(string), DateTime? createdAt = default(DateTime?), DateTime updatedAt = default(DateTime), EventNameEnum? eventName = default(EventNameEnum?), WebhookHeaders requestHeaders = default(WebhookHeaders))
        {
            this.Id = id;
            this.UserId = userId;
