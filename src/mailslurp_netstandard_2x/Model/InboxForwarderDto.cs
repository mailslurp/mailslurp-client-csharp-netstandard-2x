...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class InboxForwarderDto : IEquatable<InboxForwarderDto>, IValidatableObject
    {
        ...
        public InboxForwarderDto(DateTime createdAt = default(DateTime), FieldEnum field = default(FieldEnum), List<string> forwardToRecipients = default(List<string>), Guid id = default(Guid), Guid inboxId = default(Guid), string match = default(string))
        {
        ...
        /// </summary>
        [DataMember(Name = "forwardToRecipients", IsRequired = true, EmitDefaultValue = false)]
