...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class WebhookEmailReadPayload : IEquatable<WebhookEmailReadPayload>, IValidatableObject
    {
        ...
        public WebhookEmailReadPayload(DateTime createdAt = default(DateTime), Guid emailId = default(Guid), bool emailIsRead = default(bool), EventNameEnum? eventName = default(EventNameEnum?), Guid inboxId = default(Guid), string messageId = default(string), Guid webhookId = default(Guid), string webhookName = default(string))
        {
        ...
        [DataMember(Name = "emailIsRead", EmitDefaultValue = true)]
