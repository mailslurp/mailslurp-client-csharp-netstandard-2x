...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class AliasDto : IEquatable<AliasDto>, IValidatableObject
    {
        ...
        public AliasDto(DateTime createdAt = default(DateTime), string emailAddress = default(string), Guid id = default(Guid), Guid inboxId = default(Guid), bool isVerified = default(bool), string maskedEmailAddress = default(string), string name = default(string), DateTime updatedAt = default(DateTime), bool useThreads = default(bool), Guid userId = default(Guid))
        {
            this.Id = id;
            this.UserId = userId;
