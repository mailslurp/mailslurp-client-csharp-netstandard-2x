...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class AliasDto : IEquatable<AliasDto>, IValidatableObject
    {
        ...
        public AliasDto(Guid id = default(Guid), string emailAddress = default(string), string maskedEmailAddress = default(string), Guid userId = default(Guid), Guid inboxId = default(Guid), string name = default(string), bool useThreads = default(bool), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), bool verified = default(bool))
        {
            this.Id = id;
