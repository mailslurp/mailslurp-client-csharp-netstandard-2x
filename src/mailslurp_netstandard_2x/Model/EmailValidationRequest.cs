...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class EmailValidationRequest : IEquatable<EmailValidationRequest>, IValidatableObject
    {
        ...
        public EmailValidationRequest(Guid id = default(Guid), Guid userId = default(Guid), string emailAddress = default(string), bool isValid = default(bool), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            this.UserId = userId;
            // to ensure "emailAddress" is required (not null)
            this.EmailAddress = emailAddress ?? throw new ArgumentNullException("emailAddress is a required property for EmailValidationRequest and cannot be null");
