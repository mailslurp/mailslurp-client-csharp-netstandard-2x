...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageInboxProjection : IEquatable<PageInboxProjection>, IValidatableObject
    {
        ...
        public PageInboxProjection(List<InboxPreview> content = default(List<InboxPreview>), PageableObject pageable = default(PageableObject), int totalPages = default(int), long totalElements = default(long), bool last = default(bool), int numberOfElements = default(int), int size = default(int), int number = default(int), SortObject sort = default(SortObject), bool first = default(bool), bool empty = default(bool))
        {
