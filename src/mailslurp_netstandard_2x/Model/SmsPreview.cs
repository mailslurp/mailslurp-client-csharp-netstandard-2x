...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class SmsPreview : IEquatable<SmsPreview>, IValidatableObject
    {
        ...
        public SmsPreview(Guid id = default(Guid), Guid userId = default(Guid), Guid phoneNumber = default(Guid), string fromNumber = default(string), DateTime createdAt = default(DateTime))
        {
            this.Id = id;
            this.UserId = userId;
