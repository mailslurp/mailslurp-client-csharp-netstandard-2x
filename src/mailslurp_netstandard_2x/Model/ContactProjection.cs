...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ContactProjection : IEquatable<ContactProjection>, IValidatableObject
    {
        ...
        public ContactProjection(string emailAddress = default(string), List<string> emailAddresses = default(List<string>), string firstName = default(string), string lastName = default(string), string company = default(string), bool? optOut = default(bool?), DateTime createdAt = default(DateTime), Guid id = default(Guid), Guid? groupId = default(Guid?))
        {
