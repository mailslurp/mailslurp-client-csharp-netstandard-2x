...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ContactProjection : IEquatable<ContactProjection>, IValidatableObject
    {
        ...
        public ContactProjection(Guid id = default(Guid), DateTime createdAt = default(DateTime), Guid groupId = default(Guid), string firstName = default(string), string lastName = default(string), string company = default(string), List<string> emailAddresses = default(List<string>), bool optOut = default(bool))
        {
            this.Id = id;
