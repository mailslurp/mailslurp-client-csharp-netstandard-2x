...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ContactProjection : IEquatable<ContactProjection>, IValidatableObject
    {
        ...
        public ContactProjection(string company = default(string), DateTime createdAt = default(DateTime), List<string> emailAddresses = default(List<string>), string firstName = default(string), Guid groupId = default(Guid), Guid id = default(Guid), string lastName = default(string), bool optOut = default(bool))
        {
