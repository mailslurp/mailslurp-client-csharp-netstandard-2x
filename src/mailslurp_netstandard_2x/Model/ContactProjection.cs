...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ContactProjection : IEquatable<ContactProjection>, IValidatableObject
    {
        ...
        public ContactProjection(Guid id = default(Guid), Guid groupId = default(Guid), DateTime createdAt = default(DateTime), string lastName = default(string), string company = default(string), List<string> emailAddresses = default(List<string>), bool optOut = default(bool), string firstName = default(string))
        {
            this.Id = id;
