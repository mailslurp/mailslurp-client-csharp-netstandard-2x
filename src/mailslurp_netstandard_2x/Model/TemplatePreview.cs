...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class TemplatePreview : IEquatable<TemplatePreview>, IValidatableObject
    {
        ...
        public TemplatePreview(string preview = default(string))
        {
            ...
            this.Preview = preview ?? throw new ArgumentNullException("preview is a required property for TemplatePreview and cannot be null");
        }

        /// <summary>
        /// Gets or Sets Preview
        /// </summary>
        [DataMember(Name = "preview", IsRequired = true, EmitDefaultValue = false)]
