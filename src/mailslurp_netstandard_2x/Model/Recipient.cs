...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class Recipient : IEquatable<Recipient>, IValidatableObject
    {
        ...
        public Recipient(string emailAddress = default(string), string name = default(string), string rawValue = default(string))
        {
            // to ensure "emailAddress" is required (not null)
            this.EmailAddress = emailAddress ?? throw new ArgumentNullException("emailAddress is a required property for Recipient and cannot be null");
            // to ensure "rawValue" is required (not null)
            this.RawValue = rawValue ?? throw new ArgumentNullException("rawValue is a required property for Recipient and cannot be null");
            this.Name = name;
        }
        ...
        /// </summary>
        [DataMember(Name = "rawValue", IsRequired = true, EmitDefaultValue = false)]
