...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class WebhookProjection : IEquatable<WebhookProjection>, IValidatableObject
    {
        ...
        public WebhookProjection(string name = default(string), Guid id = default(Guid), string url = default(string), Guid inboxId = default(Guid), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), EventNameEnum? eventName = default(EventNameEnum?), Guid phoneNumberId = default(Guid))
        {
            this.Id = id;
