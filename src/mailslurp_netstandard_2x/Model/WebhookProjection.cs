...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class WebhookProjection : IEquatable<WebhookProjection>, IValidatableObject
    {
        ...
        public WebhookProjection(string url = default(string), Guid inboxId = default(Guid), EventNameEnum? eventName = default(EventNameEnum?), Guid phoneNumberId = default(Guid), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), string name = default(string), Guid id = default(Guid))
        {
