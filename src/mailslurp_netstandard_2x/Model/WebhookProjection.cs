...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class WebhookProjection : IEquatable<WebhookProjection>, IValidatableObject
    {
        ...
        public WebhookProjection(string name = default(string), Guid id = default(Guid), string url = default(string), DateTime createdAt = default(DateTime), Guid inboxId = default(Guid), EventNameEnum? eventName = default(EventNameEnum?), DateTime updatedAt = default(DateTime))
        {
            this.Id = id;
