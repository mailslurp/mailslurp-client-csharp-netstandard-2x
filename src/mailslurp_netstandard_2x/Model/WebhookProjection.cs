...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class WebhookProjection : IEquatable<WebhookProjection>, IValidatableObject
    {
        ...
        public WebhookProjection(Guid inboxId = default(Guid), EventNameEnum? eventName = default(EventNameEnum?), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), Guid phoneNumberId = default(Guid), string name = default(string), Guid id = default(Guid), string url = default(string))
        {
