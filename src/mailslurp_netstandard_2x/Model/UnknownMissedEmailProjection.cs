...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class UnknownMissedEmailProjection : IEquatable<UnknownMissedEmailProjection>, IValidatableObject
    {
        ...
        public UnknownMissedEmailProjection(List<string> to = default(List<string>), DateTime createdAt = default(DateTime), string subject = default(string), Guid id = default(Guid), string from = default(string))
        {
