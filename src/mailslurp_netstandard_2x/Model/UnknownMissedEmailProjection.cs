...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class UnknownMissedEmailProjection : IEquatable<UnknownMissedEmailProjection>, IValidatableObject
    {
        ...
        public UnknownMissedEmailProjection(string subject = default(string), List<string> to = default(List<string>), DateTime createdAt = default(DateTime), Guid id = default(Guid), string from = default(string))
        {
