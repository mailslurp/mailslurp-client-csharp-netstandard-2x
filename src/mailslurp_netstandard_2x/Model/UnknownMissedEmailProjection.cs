...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class UnknownMissedEmailProjection : IEquatable<UnknownMissedEmailProjection>, IValidatableObject
    {
        ...
        public UnknownMissedEmailProjection(DateTime createdAt = default(DateTime), string from = default(string), Guid id = default(Guid), string subject = default(string), List<string> to = default(List<string>))
        {
