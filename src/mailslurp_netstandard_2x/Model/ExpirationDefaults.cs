...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ExpirationDefaults : IEquatable<ExpirationDefaults>, IValidatableObject
    {
        ...
        public ExpirationDefaults(bool canPermanentInbox = default(bool), long defaultExpirationMillis = default(long), DateTime defaultExpiresAt = default(DateTime), long maxExpirationMillis = default(long))
        {
        ...
        /// </summary>
        [DataMember(Name = "canPermanentInbox", IsRequired = true, EmitDefaultValue = false)]
