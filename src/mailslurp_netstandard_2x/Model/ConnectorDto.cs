...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ConnectorDto : IEquatable<ConnectorDto>, IValidatableObject
    {
        ...
        public ConnectorDto(Guid id = default(Guid), Guid userId = default(Guid), ConnectorTypeEnum connectorType = default(ConnectorTypeEnum), ConnectorAuthTypeEnum connectorAuthType = default(ConnectorAuthTypeEnum), bool syncEnabled = default(bool), SyncScheduleTypeEnum syncScheduleType = default(SyncScheduleTypeEnum), int syncInterval = default(int), string imapHost = default(string), int imapPort = default(int), string imapUsername = default(string), string imapPassword = default(string), bool imapSsl = default(bool), DateTime createdAt = default(DateTime))
        {
            this.Id = id;
            this.UserId = userId;
