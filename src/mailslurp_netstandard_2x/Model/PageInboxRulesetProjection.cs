...
namespace mailslurp_netstandard_2x.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PageInboxRulesetProjection")]
    public partial class PageInboxRulesetProjection : IEquatable<PageInboxRulesetProjection>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PageInboxRulesetProjection" /> class.
        /// </summary>
        ...
        public List<InboxRulesetProjection> Content { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PageInboxRulesetProjection {\n");
        ...
        {
            return this.Equals(input as PageInboxRulesetProjection);
        }

        /// <summary>
        /// Returns true if PageInboxRulesetProjection instances are equal
        /// </summary>
        /// <param name="input">Instance of PageInboxRulesetProjection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PageInboxRulesetProjection input)
        {
            if (input == null)
                return false;
