...
namespace mailslurp_netstandard_2x.Model
{
    ...
    /// DeliveryStatus
    /// </summary>
    [DataContract(Name = "DeliveryStatus")]
    public partial class DeliveryStatus : IEquatable<DeliveryStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeliveryStatus" /> class.
        /// </summary>
        ...
        public DeliveryStatus(Guid id = default(Guid), Guid userId = default(Guid), Guid sentId = default(Guid), string remoteMtaIp = default(string), Guid inboxId = default(Guid), string reportingMta = default(string), List<string> recipients = default(List<string>), string smtpResponse = default(string), long processingTimeMillis = default(long), DateTime received = default(DateTime), string subject = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            this.UserId = userId;
        ...
        {
            return this.Equals(input as DeliveryStatus);
        }

        /// <summary>
        /// Returns true if DeliveryStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of DeliveryStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeliveryStatus input)
        {
            if (input == null)
                return false;
