...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageWebhookResult : IEquatable<PageWebhookResult>, IValidatableObject
    {
        ...
        public List<WebhookResultEntity> Content { get; set; }
