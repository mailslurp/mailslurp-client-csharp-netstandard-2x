...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ConnectorSyncEventProjection : IEquatable<ConnectorSyncEventProjection>, IValidatableObject
    {
        ...
        public ConnectorSyncEventProjection(Guid connectorId = default(Guid), long syncCount = default(long), SyncStatusEnum syncStatus = default(SyncStatusEnum), DateTime createdAt = default(DateTime), string message = default(string), Guid id = default(Guid))
        {
