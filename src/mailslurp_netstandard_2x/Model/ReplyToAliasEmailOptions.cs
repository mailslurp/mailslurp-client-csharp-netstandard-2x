...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ReplyToAliasEmailOptions : IEquatable<ReplyToAliasEmailOptions>, IValidatableObject
    {
        ...
        public ReplyToAliasEmailOptions(List<string> attachments = default(List<string>), string body = default(string), string charset = default(string), bool isHTML = default(bool), SendStrategyEnum? sendStrategy = default(SendStrategyEnum?), Guid template = default(Guid), Object templateVariables = default(Object), bool useInboxName = default(bool))
        {
