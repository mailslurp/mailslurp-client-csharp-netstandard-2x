...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class TemplateProjection : IEquatable<TemplateProjection>, IValidatableObject
    {
        ...
        public TemplateProjection(List<string> variables = default(List<string>), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), string name = default(string), Guid id = default(Guid))
        {
