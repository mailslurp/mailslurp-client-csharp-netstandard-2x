...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class InboxReplierEventProjection : IEquatable<InboxReplierEventProjection>, IValidatableObject
    {
        ...
        public InboxReplierEventProjection(string message = default(string), Guid? id = default(Guid?), StatusEnum? status = default(StatusEnum?), Guid? userId = default(Guid?), Guid? emailId = default(Guid?), Guid? inboxId = default(Guid?), DateTime createdAt = default(DateTime), Guid? replierId = default(Guid?))
        {
