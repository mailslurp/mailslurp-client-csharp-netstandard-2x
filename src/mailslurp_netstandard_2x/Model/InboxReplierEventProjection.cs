...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class InboxReplierEventProjection : IEquatable<InboxReplierEventProjection>, IValidatableObject
    {
        ...
        public InboxReplierEventProjection(Guid? emailId = default(Guid?), Guid? inboxId = default(Guid?), List<string> recipients = default(List<string>), Guid? userId = default(Guid?), DateTime createdAt = default(DateTime), Guid? sentId = default(Guid?), Guid? replierId = default(Guid?), string message = default(string), Guid? id = default(Guid?), StatusEnum? status = default(StatusEnum?))
        {
