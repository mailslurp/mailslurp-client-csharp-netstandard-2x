...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class InboxReplierEventProjection : IEquatable<InboxReplierEventProjection>, IValidatableObject
    {
        ...
        public InboxReplierEventProjection(string message = default(string), Guid? id = default(Guid?), StatusEnum? status = default(StatusEnum?), List<string> recipients = default(List<string>), Guid? emailId = default(Guid?), Guid? inboxId = default(Guid?), Guid? userId = default(Guid?), DateTime createdAt = default(DateTime), Guid? sentId = default(Guid?), Guid? replierId = default(Guid?))
        {
