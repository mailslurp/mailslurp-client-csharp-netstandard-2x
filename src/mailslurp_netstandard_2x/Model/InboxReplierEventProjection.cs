...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class InboxReplierEventProjection : IEquatable<InboxReplierEventProjection>, IValidatableObject
    {
        ...
        public InboxReplierEventProjection(DateTime createdAt = default(DateTime), List<string> recipients = default(List<string>), Guid? emailId = default(Guid?), Guid? inboxId = default(Guid?), Guid? userId = default(Guid?), Guid? sentId = default(Guid?), Guid? replierId = default(Guid?), string message = default(string), Guid? id = default(Guid?), StatusEnum? status = default(StatusEnum?))
        {
