...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageEmailPreview : IEquatable<PageEmailPreview>, IValidatableObject
    {
        ...
        public PageEmailPreview(List<EmailPreview> content = default(List<EmailPreview>), PageableObject pageable = default(PageableObject), long total = default(long), int totalPages = default(int), long totalElements = default(long), bool last = default(bool), int size = default(int), int number = default(int), Sort sort = default(Sort), int numberOfElements = default(int), bool first = default(bool), bool empty = default(bool))
        {
