...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageEmailPreview : IEquatable<PageEmailPreview>, IValidatableObject
    {
        ...
        public PageEmailPreview(List<EmailPreview> content = default(List<EmailPreview>), Pageable pageable = default(Pageable), long totalElements = default(long), int totalPages = default(int), bool last = default(bool), int size = default(int), int number = default(int), Sort sort = default(Sort), int numberOfElements = default(int), bool first = default(bool), bool empty = default(bool))
        {
