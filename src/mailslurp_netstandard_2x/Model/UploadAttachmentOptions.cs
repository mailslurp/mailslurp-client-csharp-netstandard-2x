...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class UploadAttachmentOptions : IEquatable<UploadAttachmentOptions>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="UploadAttachmentOptions" /> class.
        /// </summary>
        /// <param name="base64Contents">Base64 encoded string of file contents. Typically this means reading the bytes or string content of a file and then converting that to a base64 encoded string. (required).</param>
        ...
        /// </summary>
        /// <value>Base64 encoded string of file contents. Typically this means reading the bytes or string content of a file and then converting that to a base64 encoded string.</value>
