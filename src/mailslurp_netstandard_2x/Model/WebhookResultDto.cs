...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class WebhookResultDto : IEquatable<WebhookResultDto>, IValidatableObject
    {
        ...
        public WebhookResultDto(DateTime createdAt = default(DateTime), HttpMethodEnum httpMethod = default(HttpMethodEnum), Guid id = default(Guid), Guid inboxId = default(Guid), string messageId = default(string), Guid redriveId = default(Guid), string responseBodyExtract = default(string), int responseStatus = default(int), long responseTimeMillis = default(long), ResultTypeEnum? resultType = default(ResultTypeEnum?), bool seen = default(bool), DateTime updatedAt = default(DateTime), Guid userId = default(Guid), WebhookEventEnum webhookEvent = default(WebhookEventEnum), Guid webhookId = default(Guid), string webhookUrl = default(string))
        {
