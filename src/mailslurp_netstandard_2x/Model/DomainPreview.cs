...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class DomainPreview : IEquatable<DomainPreview>, IValidatableObject
    {
        ...
        public DomainPreview(Guid id = default(Guid), string domain = default(string), Guid catchAllInboxId = default(Guid), DateTime createdAt = default(DateTime), DomainTypeEnum? domainType = default(DomainTypeEnum?), bool verified = default(bool))
        {
            this.Id = id;
            this.Domain = domain;
