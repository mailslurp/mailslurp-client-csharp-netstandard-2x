...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageTemplateProjection : IEquatable<PageTemplateProjection>, IValidatableObject
    {
        ...
        public PageTemplateProjection(List<TemplateProjection> content = default(List<TemplateProjection>), PageableObject pageable = default(PageableObject), long total = default(long), bool last = default(bool), int totalPages = default(int), long totalElements = default(long), int size = default(int), int number = default(int), Sort sort = default(Sort), bool first = default(bool), int numberOfElements = default(int), bool empty = default(bool))
        {
