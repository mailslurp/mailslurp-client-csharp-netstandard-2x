...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageTemplateProjection : IEquatable<PageTemplateProjection>, IValidatableObject
    {
        ...
        public PageTemplateProjection(List<TemplateProjection> content = default(List<TemplateProjection>), PageableObject pageable = default(PageableObject), int totalPages = default(int), long totalElements = default(long), bool last = default(bool), int numberOfElements = default(int), int size = default(int), int number = default(int), SortObject sort = default(SortObject), bool first = default(bool), bool empty = default(bool))
        {
