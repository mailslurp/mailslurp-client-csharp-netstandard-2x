...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageTemplateProjection : IEquatable<PageTemplateProjection>, IValidatableObject
    {
        ...
        public PageTemplateProjection(List<TemplateProjection> content = default(List<TemplateProjection>), PageableObject pageable = default(PageableObject), long total = default(long), int totalPages = default(int), long totalElements = default(long), bool last = default(bool), int size = default(int), int number = default(int), Sort sort = default(Sort), int numberOfElements = default(int), bool first = default(bool), bool empty = default(bool))
        {
