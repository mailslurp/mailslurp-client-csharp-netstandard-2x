...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class Pageable : IEquatable<Pageable>, IValidatableObject
    {
        ...
        public Pageable(long offset = default(long), Sort sort = default(Sort), int pageNumber = default(int), int pageSize = default(int), bool paged = default(bool), bool unpaged = default(bool))
        {
            this.Offset = offset;
            this.Sort = sort;
