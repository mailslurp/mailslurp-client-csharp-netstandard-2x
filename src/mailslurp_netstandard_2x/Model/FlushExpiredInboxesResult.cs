...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class FlushExpiredInboxesResult : IEquatable<FlushExpiredInboxesResult>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="FlushExpiredInboxesResult" /> class.
        /// </summary>
        /// <param name="expireBefore">expireBefore (required).</param>
        /// <param name="inboxIds">inboxIds (required).</param>
        public FlushExpiredInboxesResult(DateTime expireBefore = default(DateTime), List<Guid> inboxIds = default(List<Guid>))
        {
        ...
        /// </summary>
        [DataMember(Name = "expireBefore", IsRequired = true, EmitDefaultValue = false)]
