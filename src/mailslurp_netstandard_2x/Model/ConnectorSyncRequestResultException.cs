...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ConnectorSyncRequestResultException : IEquatable<ConnectorSyncRequestResultException>, IValidatableObject
    {
        ...
        public ConnectorSyncRequestResultException(ConnectorSyncRequestResultExceptionCause cause = default(ConnectorSyncRequestResultExceptionCause), List<ConnectorSyncRequestResultExceptionCauseStackTraceInner> stackTrace = default(List<ConnectorSyncRequestResultExceptionCauseStackTraceInner>), string message = default(string), List<ConnectorSyncRequestResultExceptionCauseSuppressedInner> suppressed = default(List<ConnectorSyncRequestResultExceptionCauseSuppressedInner>), string localizedMessage = default(string))
        {
            this.Cause = cause;
        ...
        public List<ConnectorSyncRequestResultExceptionCauseSuppressedInner> Suppressed { get; set; }
