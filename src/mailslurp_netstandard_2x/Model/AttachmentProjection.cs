...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class AttachmentProjection : IEquatable<AttachmentProjection>, IValidatableObject
    {
        ...
        public AttachmentProjection(string name = default(string), long contentLength = default(long), DateTime updatedAt = default(DateTime), Guid userId = default(Guid), string attachmentId = default(string), DateTime createdAt = default(DateTime), string contentType = default(string))
        {
            this.Name = name;
