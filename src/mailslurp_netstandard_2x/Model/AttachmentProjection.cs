...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class AttachmentProjection : IEquatable<AttachmentProjection>, IValidatableObject
    {
        ...
        public AttachmentProjection(string name = default(string), long contentLength = default(long), string contentType = default(string), string attachmentId = default(string), Guid userId = default(Guid), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
