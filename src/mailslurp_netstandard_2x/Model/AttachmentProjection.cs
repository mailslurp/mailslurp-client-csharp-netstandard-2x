...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class AttachmentProjection : IEquatable<AttachmentProjection>, IValidatableObject
    {
        ...
        public AttachmentProjection(string name = default(string), long contentLength = default(long), string contentType = default(string), DateTime createdAt = default(DateTime), Guid userId = default(Guid), string attachmentId = default(string), DateTime updatedAt = default(DateTime))
        {
