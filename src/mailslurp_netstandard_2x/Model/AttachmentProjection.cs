...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class AttachmentProjection : IEquatable<AttachmentProjection>, IValidatableObject
    {
        ...
        public AttachmentProjection(Guid userId = default(Guid), string attachmentId = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), string contentId = default(string), string name = default(string), long? contentLength = default(long?), string contentType = default(string))
        {
            this.UserId = userId;
