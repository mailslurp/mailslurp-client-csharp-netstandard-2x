...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ReplyToEmailOptions : IEquatable<ReplyToEmailOptions>, IValidatableObject
    {
        ...
        public ReplyToEmailOptions(string body = default(string), string from = default(string), string replyTo = default(string), string charset = default(string), List<string> attachments = default(List<string>), Dictionary<string, Object> templateVariables = default(Dictionary<string, Object>), Guid template = default(Guid), SendStrategyEnum? sendStrategy = default(SendStrategyEnum?), bool useInboxName = default(bool), bool html = default(bool))
        {
            this.Body = body;
            this.From = from;
