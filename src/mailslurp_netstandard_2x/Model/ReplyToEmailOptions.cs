...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ReplyToEmailOptions : IEquatable<ReplyToEmailOptions>, IValidatableObject
    {
        ...
        public ReplyToEmailOptions(string body = default(string), bool isHTML = default(bool), string from = default(string), string replyTo = default(string), string charset = default(string), List<string> attachments = default(List<string>), Dictionary<string, Object> templateVariables = default(Dictionary<string, Object>), Guid template = default(Guid), SendStrategyEnum? sendStrategy = default(SendStrategyEnum?), bool useInboxName = default(bool))
        {
            // to ensure "body" is required (not null)
            this.Body = body ?? throw new ArgumentNullException("body is a required property for ReplyToEmailOptions and cannot be null");
            this.IsHTML = isHTML;
            this.From = from;
