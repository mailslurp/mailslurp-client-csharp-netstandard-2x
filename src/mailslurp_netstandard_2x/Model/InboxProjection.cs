...
namespace mailslurp_netstandard_2x.Model
{
    ...
    /// InboxProjection
    /// </summary>
    [DataContract(Name = "InboxProjection")]
    public partial class InboxProjection : IEquatable<InboxProjection>, IValidatableObject
    {
        ...
        /// <param name="inboxType">inboxType.</param>
        /// <param name="name">name.</param>
        /// <param name="tags">tags.</param>
        /// <param name="teamAccess">teamAccess (required).</param>
        public InboxProjection(DateTime createdAt = default(DateTime), string emailAddress = default(string), bool favourite = default(bool), Guid id = default(Guid), InboxTypeEnum? inboxType = default(InboxTypeEnum?), string name = default(string), List<string> tags = default(List<string>), bool teamAccess = default(bool))
        {
        ...
        /// </summary>
        [DataMember(Name = "favourite", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "teamAccess", IsRequired = true, EmitDefaultValue = false)]
