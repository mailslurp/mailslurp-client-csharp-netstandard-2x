...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageUnknownMissedEmailProjection : IEquatable<PageUnknownMissedEmailProjection>, IValidatableObject
    {
        ...
        public PageUnknownMissedEmailProjection(List<UnknownMissedEmailProjection> content = default(List<UnknownMissedEmailProjection>), PageableObject pageable = default(PageableObject), int totalPages = default(int), long totalElements = default(long), bool last = default(bool), int numberOfElements = default(int), int size = default(int), int number = default(int), SortObject sort = default(SortObject), bool first = default(bool), bool empty = default(bool))
        {
