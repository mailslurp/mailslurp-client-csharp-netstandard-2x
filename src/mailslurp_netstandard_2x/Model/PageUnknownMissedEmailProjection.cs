...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageUnknownMissedEmailProjection : IEquatable<PageUnknownMissedEmailProjection>, IValidatableObject
    {
        ...
        public PageUnknownMissedEmailProjection(List<UnknownMissedEmailProjection> content = default(List<UnknownMissedEmailProjection>), PageableObject pageable = default(PageableObject), long total = default(long), int totalPages = default(int), long totalElements = default(long), bool last = default(bool), int size = default(int), int number = default(int), Sort sort = default(Sort), int numberOfElements = default(int), bool first = default(bool), bool empty = default(bool))
        {
