...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class AliasProjection : IEquatable<AliasProjection>, IValidatableObject
    {
        ...
        public AliasProjection(string name = default(string), Guid id = default(Guid), DateTime createdAt = default(DateTime), Guid userId = default(Guid), string emailAddress = default(string), Guid inboxId = default(Guid), bool useThreads = default(bool), DateTime updatedAt = default(DateTime))
        {
            this.Id = id;
