...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class AliasProjection : IEquatable<AliasProjection>, IValidatableObject
    {
        ...
        public AliasProjection(string name = default(string), Guid id = default(Guid), Guid inboxId = default(Guid), Guid userId = default(Guid), string emailAddress = default(string), DateTime createdAt = default(DateTime), bool useThreads = default(bool), DateTime updatedAt = default(DateTime))
        {
            this.Id = id;
