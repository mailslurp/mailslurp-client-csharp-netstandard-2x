...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class AliasProjection : IEquatable<AliasProjection>, IValidatableObject
    {
        ...
        public AliasProjection(string name = default(string), Guid id = default(Guid), DateTime updatedAt = default(DateTime), Guid userId = default(Guid), string emailAddress = default(string), Guid inboxId = default(Guid), DateTime createdAt = default(DateTime), bool useThreads = default(bool))
        {
            this.Name = name;
            this.Id = id;
