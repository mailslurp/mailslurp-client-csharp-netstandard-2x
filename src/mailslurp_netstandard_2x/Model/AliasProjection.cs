...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class AliasProjection : IEquatable<AliasProjection>, IValidatableObject
    {
        ...
        public AliasProjection(Guid inboxId = default(Guid), string emailAddress = default(string), Guid userId = default(Guid), bool useThreads = default(bool), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), string name = default(string), Guid id = default(Guid))
        {
