...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class AliasProjection : IEquatable<AliasProjection>, IValidatableObject
    {
        ...
        public AliasProjection(DateTime createdAt = default(DateTime), string emailAddress = default(string), Guid id = default(Guid), Guid inboxId = default(Guid), string name = default(string), DateTime updatedAt = default(DateTime), bool useThreads = default(bool), Guid userId = default(Guid))
        {
