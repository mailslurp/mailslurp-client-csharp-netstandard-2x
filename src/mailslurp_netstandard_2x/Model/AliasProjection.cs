...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class AliasProjection : IEquatable<AliasProjection>, IValidatableObject
    {
        ...
        public AliasProjection(string emailAddress = default(string), Guid inboxId = default(Guid), Guid userId = default(Guid), bool useThreads = default(bool), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), string name = default(string), Guid id = default(Guid))
        {
