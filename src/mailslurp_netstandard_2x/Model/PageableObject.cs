...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageableObject : IEquatable<PageableObject>, IValidatableObject
    {
        ...
        public PageableObject(int pageNumber = default(int), int pageSize = default(int), bool paged = default(bool), bool unpaged = default(bool), long offset = default(long), SortObject sort = default(SortObject))
        {
