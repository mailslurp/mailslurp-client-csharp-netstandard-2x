...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageableObject : IEquatable<PageableObject>, IValidatableObject
    {
        ...
        public PageableObject(long offset = default(long), Sort sort = default(Sort), bool paged = default(bool), bool unpaged = default(bool), int pageNumber = default(int), int pageSize = default(int))
        {
            this.Offset = offset;
            this.Sort = sort;
            this.Paged = paged;
