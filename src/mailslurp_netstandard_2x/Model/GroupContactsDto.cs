...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class GroupContactsDto : IEquatable<GroupContactsDto>, IValidatableObject
    {
        ...
        public GroupContactsDto(GroupDto group = default(GroupDto), List<ContactDto> contacts = default(List<ContactDto>))
        {
            ...
            this.Group = group ?? throw new ArgumentNullException("group is a required property for GroupContactsDto and cannot be null");
            // to ensure "contacts" is required (not null)
            this.Contacts = contacts ?? throw new ArgumentNullException("contacts is a required property for GroupContactsDto and cannot be null");
        }
