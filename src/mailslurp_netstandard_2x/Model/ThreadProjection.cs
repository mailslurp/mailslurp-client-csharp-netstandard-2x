...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ThreadProjection : IEquatable<ThreadProjection>, IValidatableObject
    {
        ...
        public ThreadProjection(DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), Guid userId = default(Guid), Guid inboxId = default(Guid), List<string> to = default(List<string>), List<string> bcc = default(List<string>), List<string> cc = default(List<string>), Guid aliasId = default(Guid), string subject = default(string), string name = default(string), Guid id = default(Guid))
        {
