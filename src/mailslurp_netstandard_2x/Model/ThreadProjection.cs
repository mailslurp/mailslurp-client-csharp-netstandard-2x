...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ThreadProjection : IEquatable<ThreadProjection>, IValidatableObject
    {
        ...
        public ThreadProjection(string name = default(string), Guid id = default(Guid), Guid inboxId = default(Guid), string subject = default(string), Guid userId = default(Guid), List<string> to = default(List<string>), List<string> bcc = default(List<string>), List<string> cc = default(List<string>), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), Guid aliasId = default(Guid))
        {
            this.Id = id;
