...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class SentEmailProjection : IEquatable<SentEmailProjection>, IValidatableObject
    {
        ...
        public SentEmailProjection(Guid id = default(Guid), string from = default(string), Guid userId = default(Guid), string subject = default(string), string bodyMD5Hash = default(string), Guid inboxId = default(Guid), List<string> to = default(List<string>), List<string> attachments = default(List<string>), List<string> bcc = default(List<string>), List<string> cc = default(List<string>), DateTime createdAt = default(DateTime))
        {
            this.Id = id;
            this.From = from;
            this.UserId = userId;
