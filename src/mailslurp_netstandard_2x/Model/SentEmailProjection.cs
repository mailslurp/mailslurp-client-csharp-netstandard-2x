...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class SentEmailProjection : IEquatable<SentEmailProjection>, IValidatableObject
    {
        ...
        public SentEmailProjection(Guid id = default(Guid), string from = default(string), Guid userId = default(Guid), string subject = default(string), List<string> to = default(List<string>), Guid inboxId = default(Guid), List<string> attachments = default(List<string>), string bodyMD5Hash = default(string), DateTime createdAt = default(DateTime), List<string> bcc = default(List<string>), List<string> cc = default(List<string>), bool virtualSend = default(bool))
        {
            this.Id = id;
            this.UserId = userId;
