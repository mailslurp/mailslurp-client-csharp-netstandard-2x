...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class SentEmailProjection : IEquatable<SentEmailProjection>, IValidatableObject
    {
        ...
        public SentEmailProjection(DateTime createdAt = default(DateTime), Guid id = default(Guid), string subject = default(string), string from = default(string), List<string> attachments = default(List<string>), Guid userId = default(Guid), Guid inboxId = default(Guid), List<string> to = default(List<string>), List<string> bcc = default(List<string>), List<string> cc = default(List<string>), string bodyMD5Hash = default(string), bool virtualSend = default(bool))
        {
