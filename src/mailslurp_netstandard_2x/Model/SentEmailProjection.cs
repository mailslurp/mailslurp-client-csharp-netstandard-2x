...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class SentEmailProjection : IEquatable<SentEmailProjection>, IValidatableObject
    {
        ...
        public SentEmailProjection(Guid id = default(Guid), string from = default(string), string subject = default(string), Guid userId = default(Guid), Guid inboxId = default(Guid), List<string> attachments = default(List<string>), List<string> to = default(List<string>), List<string> bcc = default(List<string>), List<string> cc = default(List<string>), DateTime createdAt = default(DateTime), string bodyMD5Hash = default(string), bool virtualSend = default(bool))
        {
            this.Id = id;
            this.UserId = userId;
