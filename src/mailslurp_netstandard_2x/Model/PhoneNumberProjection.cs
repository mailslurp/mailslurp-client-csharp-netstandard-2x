...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PhoneNumberProjection : IEquatable<PhoneNumberProjection>, IValidatableObject
    {
        ...
        public PhoneNumberProjection(Guid id = default(Guid), Guid userId = default(Guid), string phoneNumber = default(string), DateTime createdAt = default(DateTime), PhoneCountryEnum phoneCountry = default(PhoneCountryEnum))
        {
            this.Id = id;
            this.UserId = userId;
