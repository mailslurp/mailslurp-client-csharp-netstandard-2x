...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PhoneNumberProjection : IEquatable<PhoneNumberProjection>, IValidatableObject
    {
        ...
        public PhoneNumberProjection(Guid id = default(Guid), Guid userId = default(Guid), PhoneCountryEnum phoneCountry = default(PhoneCountryEnum), DateTime createdAt = default(DateTime), string phoneNumber = default(string))
        {
            this.Id = id;
            this.UserId = userId;
