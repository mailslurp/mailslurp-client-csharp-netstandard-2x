...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PhoneNumberProjection : IEquatable<PhoneNumberProjection>, IValidatableObject
    {
        ...
        public PhoneNumberProjection(Guid userId = default(Guid), string phoneNumber = default(string), PhoneCountryEnum phoneCountry = default(PhoneCountryEnum), DateTime createdAt = default(DateTime), Guid id = default(Guid))
        {
            this.UserId = userId;
