...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PhoneNumberProjection : IEquatable<PhoneNumberProjection>, IValidatableObject
    {
        ...
        public PhoneNumberProjection(Guid id = default(Guid), Guid userId = default(Guid), string phoneNumber = default(string), PhoneCountryEnum phoneCountry = default(PhoneCountryEnum), DateTime createdAt = default(DateTime))
        {
            this.Id = id;
            this.UserId = userId;
            // to ensure "phoneNumber" is required (not null)
            this.PhoneNumber = phoneNumber ?? throw new ArgumentNullException("phoneNumber is a required property for PhoneNumberProjection and cannot be null");
