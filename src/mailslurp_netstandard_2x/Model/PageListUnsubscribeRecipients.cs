...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageListUnsubscribeRecipients : IEquatable<PageListUnsubscribeRecipients>, IValidatableObject
    {
        ...
        public PageListUnsubscribeRecipients(List<ListUnsubscribeRecipientProjection> content = default(List<ListUnsubscribeRecipientProjection>), PageableObject pageable = default(PageableObject), long total = default(long), int totalPages = default(int), long totalElements = default(long), bool last = default(bool), int size = default(int), int number = default(int), Sort sort = default(Sort), int numberOfElements = default(int), bool first = default(bool), bool empty = default(bool))
        {
