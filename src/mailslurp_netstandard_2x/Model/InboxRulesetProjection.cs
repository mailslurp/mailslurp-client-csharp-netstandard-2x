...
namespace mailslurp_netstandard_2x.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InboxRulesetProjection")]
    public partial class InboxRulesetProjection : IEquatable<InboxRulesetProjection>, IValidatableObject
    {
        /// <summary>
        /// Defines Action
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InboxRulesetProjection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InboxRulesetProjection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InboxRulesetProjection" /> class.
        /// </summary>
        ...
        public InboxRulesetProjection(ActionEnum action = default(ActionEnum), HandlerEnum handler = default(HandlerEnum), Guid id = default(Guid), Guid inboxId = default(Guid), ScopeEnum scope = default(ScopeEnum), string target = default(string))
        {
            this.Action = action;
            ...
            this.Target = target ?? throw new ArgumentNullException("target is a required property for InboxRulesetProjection and cannot be null");
        }
        ...
        {
            return this.Equals(input as InboxRulesetProjection);
        }

        /// <summary>
        /// Returns true if InboxRulesetProjection instances are equal
        /// </summary>
        /// <param name="input">Instance of InboxRulesetProjection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InboxRulesetProjection input)
        {
            if (input == null)
                return false;
