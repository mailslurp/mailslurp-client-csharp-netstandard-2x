...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class TrackingPixelDto : IEquatable<TrackingPixelDto>, IValidatableObject
    {
        ...
        public TrackingPixelDto(DateTime createdAt = default(DateTime), string html = default(string), Guid id = default(Guid), Guid inboxId = default(Guid), string recipient = default(string), bool seen = default(bool), DateTime seenAt = default(DateTime), Guid sentEmailId = default(Guid), string url = default(string))
        {
