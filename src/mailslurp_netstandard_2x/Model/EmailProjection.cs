...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class EmailProjection : IEquatable<EmailProjection>, IValidatableObject
    {
        ...
        public EmailProjection(Guid id = default(Guid), string from = default(string), string subject = default(string), Guid inboxId = default(Guid), DateTime createdAt = default(DateTime), List<string> attachments = default(List<string>), List<string> to = default(List<string>), List<string> bcc = default(List<string>), List<string> cc = default(List<string>), Guid? domainId = default(Guid?), string bodyMD5Hash = default(string), bool read = default(bool), string bodyExcerpt = default(string), bool teamAccess = default(bool))
        {
            this.Id = id;
