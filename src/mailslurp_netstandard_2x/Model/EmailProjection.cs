...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class EmailProjection : IEquatable<EmailProjection>, IValidatableObject
    {
        ...
        public EmailProjection(Guid id = default(Guid), string from = default(string), string subject = default(string), Guid inboxId = default(Guid), List<string> attachments = default(List<string>), string bodyMD5Hash = default(string), string bodyExcerpt = default(string), List<string> to = default(List<string>), DateTime createdAt = default(DateTime), List<string> bcc = default(List<string>), List<string> cc = default(List<string>), Guid domainId = default(Guid), bool teamAccess = default(bool), bool read = default(bool))
        {
            this.Id = id;
