...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class EmailProjection : IEquatable<EmailProjection>, IValidatableObject
    {
        ...
        public EmailProjection(Guid id = default(Guid), string from = default(string), string subject = default(string), List<string> attachments = default(List<string>), Guid inboxId = default(Guid), List<string> to = default(List<string>), DateTime createdAt = default(DateTime), List<string> bcc = default(List<string>), List<string> cc = default(List<string>), Guid domainId = default(Guid), string bodyMD5Hash = default(string), string bodyExcerpt = default(string), bool read = default(bool), bool teamAccess = default(bool))
        {
            this.Id = id;
