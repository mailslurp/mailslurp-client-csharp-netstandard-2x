...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class EmailProjection : IEquatable<EmailProjection>, IValidatableObject
    {
        ...
        public EmailProjection(string subject = default(string), List<string> attachments = default(List<string>), Guid inboxId = default(Guid), List<string> to = default(List<string>), List<string> bcc = default(List<string>), List<string> cc = default(List<string>), Guid? domainId = default(Guid?), bool read = default(bool), string bodyExcerpt = default(string), bool teamAccess = default(bool), string bodyMD5Hash = default(string), string textExcerpt = default(string), DateTime createdAt = default(DateTime), Guid id = default(Guid), string from = default(string))
        {
