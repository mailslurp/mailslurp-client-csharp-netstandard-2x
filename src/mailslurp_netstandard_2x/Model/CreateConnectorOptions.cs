...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class CreateConnectorOptions : IEquatable<CreateConnectorOptions>, IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets FetchSettings
        /// </summary>
        [DataMember(Name = "fetchSettings", EmitDefaultValue = false)]
        public CreateConnectorImapFetchOptions FetchSettings { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  FetchSettings: ").Append(FetchSettings).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(CreateConnectorOptions input)
        {
            ...
            return 
                ...
                (
                    this.FetchSettings == input.FetchSettings ||
                    (this.FetchSettings != null &&
                    this.FetchSettings.Equals(input.FetchSettings))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.FetchSettings.GetHashCode();
                }
                return hashCode;
            }
        }
