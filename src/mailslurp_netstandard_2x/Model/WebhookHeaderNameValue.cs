...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class WebhookHeaderNameValue : IEquatable<WebhookHeaderNameValue>, IValidatableObject
    {
        ...
        public WebhookHeaderNameValue(string name = default(string), string value = default(string))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for WebhookHeaderNameValue and cannot be null");
            // to ensure "value" is required (not null)
            this.Value = value ?? throw new ArgumentNullException("value is a required property for WebhookHeaderNameValue and cannot be null");
        }
