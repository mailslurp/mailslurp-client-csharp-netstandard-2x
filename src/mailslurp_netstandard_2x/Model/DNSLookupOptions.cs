...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class DNSLookupOptions : IEquatable<DNSLookupOptions>, IValidatableObject
    {
        ...
        [DataMember(Name = "recordTypes", IsRequired = true, EmitDefaultValue = false)]
        public List<RecordTypesEnum> RecordTypes { get; set; }
        /// <summary>
        ...
        public DNSLookupOptions(string hostname = default(string), List<RecordTypesEnum> recordTypes = default(List<RecordTypesEnum>), bool omitFinalDNSDot = default(bool))
        {
            ...
            this.Hostname = hostname ?? throw new ArgumentNullException("hostname is a required property for DNSLookupOptions and cannot be null");
            // to ensure "recordTypes" is required (not null)
            this.RecordTypes = recordTypes ?? throw new ArgumentNullException("recordTypes is a required property for DNSLookupOptions and cannot be null");
        ...
        [DataMember(Name = "omitFinalDNSDot", EmitDefaultValue = true)]
