...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class DNSLookupOptions : IEquatable<DNSLookupOptions>, IValidatableObject
    {
        ...
        public DNSLookupOptions(string hostname = default(string), bool omitFinalDNSDot = default(bool), List<RecordTypesEnum> recordTypes = default(List<RecordTypesEnum>))
        {
        ...
        [DataMember(Name = "omitFinalDNSDot", EmitDefaultValue = false)]
