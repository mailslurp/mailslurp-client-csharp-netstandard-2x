...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class DomainNameRecord : IEquatable<DomainNameRecord>, IValidatableObject
    {
        ...
        public DomainNameRecord(string name = default(string), List<string> recordEntries = default(List<string>), RecordTypeEnum recordType = default(RecordTypeEnum), long ttl = default(long))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for DomainNameRecord and cannot be null");
            // to ensure "recordEntries" is required (not null)
            this.RecordEntries = recordEntries ?? throw new ArgumentNullException("recordEntries is a required property for DomainNameRecord and cannot be null");
