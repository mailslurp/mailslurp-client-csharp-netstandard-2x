...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class DomainNameRecord : IEquatable<DomainNameRecord>, IValidatableObject
    {
        ...
        public DomainNameRecord(LabelEnum label = default(LabelEnum), bool required = default(bool), RecordTypeEnum recordType = default(RecordTypeEnum), string name = default(string), List<string> recordEntries = default(List<string>), long ttl = default(long))
        {
            this.Label = label;
