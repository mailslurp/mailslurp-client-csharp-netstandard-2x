...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class AttachmentEntity : IEquatable<AttachmentEntity>, IValidatableObject
    {
        ...
        public AttachmentEntity(Guid id = default(Guid), string attachmentId = default(string), Guid userId = default(Guid), string contentType = default(string), long contentLength = default(long), string name = default(string), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime))
        {
            this.Id = id;
