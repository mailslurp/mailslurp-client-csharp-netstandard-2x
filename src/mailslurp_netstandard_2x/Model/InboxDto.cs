...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class InboxDto : IEquatable<InboxDto>, IValidatableObject
    {
        ...
        public InboxDto(Guid id = default(Guid), Guid userId = default(Guid), DateTime createdAt = default(DateTime), string name = default(string), string description = default(string), string emailAddress = default(string), string expiresAt = default(string), bool favourite = default(bool), List<string> tags = default(List<string>), InboxTypeEnum? inboxType = default(InboxTypeEnum?), bool readOnly = default(bool))
        {
            this.Id = id;
            this.CreatedAt = createdAt;
            // to ensure "emailAddress" is required (not null)
            this.EmailAddress = emailAddress ?? throw new ArgumentNullException("emailAddress is a required property for InboxDto and cannot be null");
