...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class Sender : IEquatable<Sender>, IValidatableObject
    {
        ...
        public Sender(string emailAddress = default(string), string name = default(string), string rawValue = default(string))
        {
            // to ensure "emailAddress" is required (not null)
            this.EmailAddress = emailAddress ?? throw new ArgumentNullException("emailAddress is a required property for Sender and cannot be null");
            // to ensure "rawValue" is required (not null)
            this.RawValue = rawValue ?? throw new ArgumentNullException("rawValue is a required property for Sender and cannot be null");
            this.Name = name;
        }
