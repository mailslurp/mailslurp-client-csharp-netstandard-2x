...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ConnectorSyncRequestResultExceptionCause : IEquatable<ConnectorSyncRequestResultExceptionCause>, IValidatableObject
    {
        ...
        public ConnectorSyncRequestResultExceptionCause(List<ConnectorSyncRequestResultExceptionCauseStackTraceInner> stackTrace = default(List<ConnectorSyncRequestResultExceptionCauseStackTraceInner>), string message = default(string), List<ConnectorSyncRequestResultExceptionCauseSuppressedInner> suppressed = default(List<ConnectorSyncRequestResultExceptionCauseSuppressedInner>), string localizedMessage = default(string))
        {
