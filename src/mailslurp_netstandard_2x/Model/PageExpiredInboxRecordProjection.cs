...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageExpiredInboxRecordProjection : IEquatable<PageExpiredInboxRecordProjection>, IValidatableObject
    {
        ...
        public PageExpiredInboxRecordProjection(List<ExpiredInboxRecordProjection> content = default(List<ExpiredInboxRecordProjection>), Pageable pageable = default(Pageable), bool last = default(bool), int totalPages = default(int), long totalElements = default(long), int size = default(int), int number = default(int), Sort sort = default(Sort), bool first = default(bool), int numberOfElements = default(int), bool empty = default(bool))
        {
