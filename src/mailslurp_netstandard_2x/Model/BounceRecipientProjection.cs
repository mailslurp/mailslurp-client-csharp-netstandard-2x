...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class BounceRecipientProjection : IEquatable<BounceRecipientProjection>, IValidatableObject
    {
        ...
        public BounceRecipientProjection(DateTime createdAt = default(DateTime), Guid? sentEmailId = default(Guid?), string recipient = default(string), string action = default(string), string bounceType = default(string), Guid id = default(Guid), string status = default(string))
        {
