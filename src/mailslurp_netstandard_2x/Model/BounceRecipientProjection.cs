...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class BounceRecipientProjection : IEquatable<BounceRecipientProjection>, IValidatableObject
    {
        ...
        public BounceRecipientProjection(Guid id = default(Guid), string status = default(string), DateTime createdAt = default(DateTime), Guid? sentEmailId = default(Guid?), string recipient = default(string), string action = default(string))
        {
