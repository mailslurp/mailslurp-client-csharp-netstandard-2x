...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class BounceRecipientProjection : IEquatable<BounceRecipientProjection>, IValidatableObject
    {
        ...
        public BounceRecipientProjection(Guid? sentEmailId = default(Guid?), string recipient = default(string), string bounceType = default(string), string action = default(string), DateTime createdAt = default(DateTime), Guid id = default(Guid), string status = default(string))
        {
