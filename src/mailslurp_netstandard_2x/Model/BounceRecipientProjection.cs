...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class BounceRecipientProjection : IEquatable<BounceRecipientProjection>, IValidatableObject
    {
        ...
        public BounceRecipientProjection(Guid? sentEmailId = default(Guid?), DateTime createdAt = default(DateTime), string recipient = default(string), string action = default(string), string bounceType = default(string), Guid id = default(Guid), string status = default(string))
        {
