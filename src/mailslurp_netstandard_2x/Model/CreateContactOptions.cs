...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class CreateContactOptions : IEquatable<CreateContactOptions>, IValidatableObject
    {
        ...
        public CreateContactOptions(List<string> emailAddresses = default(List<string>), string firstName = default(string), Guid groupId = default(Guid), Object metaData = default(Object), bool optOut = default(bool), List<string> tags = default(List<string>), string lastName = default(string), string company = default(string))
        {
