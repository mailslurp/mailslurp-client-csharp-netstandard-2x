...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class BounceProjection : IEquatable<BounceProjection>, IValidatableObject
    {
        ...
        public BounceProjection(Guid id = default(Guid), string sender = default(string), string subject = default(string), DateTime createdAt = default(DateTime), string bounceType = default(string), string bounceMta = default(string))
        {
