...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class BounceProjection : IEquatable<BounceProjection>, IValidatableObject
    {
        ...
        public BounceProjection(Guid id = default(Guid), string subject = default(string), string sender = default(string), DateTime createdAt = default(DateTime), string bounceMta = default(string), string bounceType = default(string))
        {
