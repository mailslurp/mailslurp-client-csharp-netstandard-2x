...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class BounceProjection : IEquatable<BounceProjection>, IValidatableObject
    {
        ...
        public BounceProjection(string sender = default(string), string bounceType = default(string), string bounceMta = default(string), DateTime createdAt = default(DateTime), string subject = default(string), Guid id = default(Guid))
        {
