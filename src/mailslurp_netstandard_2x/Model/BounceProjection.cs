...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class BounceProjection : IEquatable<BounceProjection>, IValidatableObject
    {
        ...
        public BounceProjection(string subject = default(string), string sender = default(string), string bounceType = default(string), string bounceMta = default(string), DateTime createdAt = default(DateTime), Guid id = default(Guid))
        {
