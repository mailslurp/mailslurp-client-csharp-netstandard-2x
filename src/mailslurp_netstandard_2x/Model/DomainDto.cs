...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class DomainDto : IEquatable<DomainDto>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The type of domain. SMTP or HTTP domains differ in what inboxes can be used with them.</value>
        ...
        /// <param name="domainType">The type of domain. SMTP or HTTP domains differ in what inboxes can be used with them..</param>
        ...
        public DomainDto(Guid catchAllInboxId = default(Guid), DateTime createdAt = default(DateTime), List<string> dkimTokens = default(List<string>), string domain = default(string), List<DomainNameRecord> domainNameRecords = default(List<DomainNameRecord>), DomainTypeEnum? domainType = default(DomainTypeEnum?), Guid id = default(Guid), bool isVerified = default(bool), DateTime updatedAt = default(DateTime), Guid userId = default(Guid), string verificationToken = default(string))
        {
