...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class MissedEmailProjection : IEquatable<MissedEmailProjection>, IValidatableObject
    {
        ...
        public MissedEmailProjection(Guid? userId = default(Guid?), DateTime createdAt = default(DateTime), string subject = default(string), Guid id = default(Guid), string from = default(string))
        {
