...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class MissedEmailProjection : IEquatable<MissedEmailProjection>, IValidatableObject
    {
        ...
        public MissedEmailProjection(Guid id = default(Guid), string from = default(string), DateTime createdAt = default(DateTime), string subject = default(string), Guid userId = default(Guid))
        {
            this.Id = id;
