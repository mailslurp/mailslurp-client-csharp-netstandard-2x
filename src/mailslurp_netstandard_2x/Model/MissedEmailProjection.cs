...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class MissedEmailProjection : IEquatable<MissedEmailProjection>, IValidatableObject
    {
        ...
        public MissedEmailProjection(DateTime createdAt = default(DateTime), string from = default(string), Guid id = default(Guid), string subject = default(string), Guid userId = default(Guid))
        {
