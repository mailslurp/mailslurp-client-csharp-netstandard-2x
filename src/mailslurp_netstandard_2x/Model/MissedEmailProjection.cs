...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class MissedEmailProjection : IEquatable<MissedEmailProjection>, IValidatableObject
    {
        ...
        public MissedEmailProjection(Guid id = default(Guid), string from = default(string), Guid userId = default(Guid), string subject = default(string), DateTime createdAt = default(DateTime))
        {
            this.Id = id;
