...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class MissedEmailProjection : IEquatable<MissedEmailProjection>, IValidatableObject
    {
        ...
        public MissedEmailProjection(string subject = default(string), Guid? userId = default(Guid?), DateTime createdAt = default(DateTime), Guid id = default(Guid), string from = default(string))
        {
