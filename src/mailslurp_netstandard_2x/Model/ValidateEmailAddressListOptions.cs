...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ValidateEmailAddressListOptions : IEquatable<ValidateEmailAddressListOptions>, IValidatableObject
    {
        ...
        public ValidateEmailAddressListOptions(List<string> emailAddressList = default(List<string>))
        {
            // to ensure "emailAddressList" is required (not null)
            this.EmailAddressList = emailAddressList ?? throw new ArgumentNullException("emailAddressList is a required property for ValidateEmailAddressListOptions and cannot be null");
        }

        /// <summary>
        /// Gets or Sets EmailAddressList
        /// </summary>
        [DataMember(Name = "emailAddressList", IsRequired = true, EmitDefaultValue = false)]
