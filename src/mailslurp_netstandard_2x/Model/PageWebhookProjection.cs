...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class PageWebhookProjection : IEquatable<PageWebhookProjection>, IValidatableObject
    {
        ...
        public PageWebhookProjection(List<WebhookProjection> content = default(List<WebhookProjection>), PageableObject pageable = default(PageableObject), long total = default(long), long totalElements = default(long), int totalPages = default(int), bool last = default(bool), int size = default(int), int number = default(int), Sort sort = default(Sort), int numberOfElements = default(int), bool first = default(bool), bool empty = default(bool))
        {
