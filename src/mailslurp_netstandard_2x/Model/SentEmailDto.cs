...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class SentEmailDto : IEquatable<SentEmailDto>, IValidatableObject
    {
        ...
        public SentEmailDto(List<string> attachments = default(List<string>), List<string> bcc = default(List<string>), string body = default(string), string bodyMD5Hash = default(string), List<string> cc = default(List<string>), string charset = default(string), string from = default(string), Guid id = default(Guid), Guid inboxId = default(Guid), bool isHTML = default(bool), List<Guid> pixelIds = default(List<Guid>), string replyTo = default(string), DateTime sentAt = default(DateTime), string subject = default(string), List<string> to = default(List<string>), Guid userId = default(Guid))
        {
            this.SentAt = sentAt;
