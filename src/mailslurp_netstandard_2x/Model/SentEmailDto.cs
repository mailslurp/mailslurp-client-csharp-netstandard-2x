...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class SentEmailDto : IEquatable<SentEmailDto>, IValidatableObject
    {
        ...
        public SentEmailDto(Guid id = default(Guid), Guid userId = default(Guid), Guid inboxId = default(Guid), List<string> to = default(List<string>), string from = default(string), string replyTo = default(string), List<string> cc = default(List<string>), List<string> bcc = default(List<string>), List<string> attachments = default(List<string>), string subject = default(string), string bodyMD5Hash = default(string), string body = default(string), string charset = default(string), bool isHTML = default(bool), DateTime sentAt = default(DateTime), List<Guid> pixelIds = default(List<Guid>))
        {
            this.Id = id;
            this.UserId = userId;
