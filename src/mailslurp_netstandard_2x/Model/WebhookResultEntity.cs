...
namespace mailslurp_netstandard_2x.Model
{
    ...
    /// WebhookResultEntity
    /// </summary>
    [DataContract(Name = "WebhookResultEntity")]
    public partial class WebhookResultEntity : IEquatable<WebhookResultEntity>, IValidatableObject
    {
        /// <summary>
        /// Defines HttpMethod
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookResultEntity" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WebhookResultEntity() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookResultEntity" /> class.
        /// </summary>
        ...
        public WebhookResultEntity(DateTime createdAt = default(DateTime), HttpMethodEnum httpMethod = default(HttpMethodEnum), Guid id = default(Guid), Guid inboxId = default(Guid), string messageId = default(string), string responseBodyExtract = default(string), int responseStatus = default(int), long responseTimeMillis = default(long), ResultTypeEnum? resultType = default(ResultTypeEnum?), DateTime updatedAt = default(DateTime), Guid userId = default(Guid), WebhookEventEnum webhookEvent = default(WebhookEventEnum), Guid webhookId = default(Guid), string webhookUrl = default(string))
        {
            this.CreatedAt = createdAt;
            this.HttpMethod = httpMethod;
            this.InboxId = inboxId;
            // to ensure "messageId" is required (not null)
            this.MessageId = messageId ?? throw new ArgumentNullException("messageId is a required property for WebhookResultEntity and cannot be null");
            ...
            this.WebhookUrl = webhookUrl ?? throw new ArgumentNullException("webhookUrl is a required property for WebhookResultEntity and cannot be null");
            this.Id = id;
        ...
        {
            return this.Equals(input as WebhookResultEntity);
        }

        /// <summary>
        /// Returns true if WebhookResultEntity instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookResultEntity to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookResultEntity input)
        {
            if (input == null)
                return false;
