...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ExpiredInboxRecordProjection : IEquatable<ExpiredInboxRecordProjection>, IValidatableObject
    {
        ...
        public ExpiredInboxRecordProjection(Guid userId = default(Guid), string emailAddress = default(string), DateTime createdAt = default(DateTime), Guid id = default(Guid))
        {
            this.UserId = userId;
