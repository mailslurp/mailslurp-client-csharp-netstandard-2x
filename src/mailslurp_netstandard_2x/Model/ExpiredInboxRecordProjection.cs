...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ExpiredInboxRecordProjection : IEquatable<ExpiredInboxRecordProjection>, IValidatableObject
    {
        ...
        public ExpiredInboxRecordProjection(Guid id = default(Guid), Guid userId = default(Guid), string emailAddress = default(string), DateTime createdAt = default(DateTime))
        {
            this.Id = id;
            this.UserId = userId;
