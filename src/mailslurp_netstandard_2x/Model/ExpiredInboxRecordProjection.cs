...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ExpiredInboxRecordProjection : IEquatable<ExpiredInboxRecordProjection>, IValidatableObject
    {
        ...
        public ExpiredInboxRecordProjection(DateTime createdAt = default(DateTime), string emailAddress = default(string), Guid id = default(Guid), Guid userId = default(Guid))
        {
