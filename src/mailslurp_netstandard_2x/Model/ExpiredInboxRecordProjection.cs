...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ExpiredInboxRecordProjection : IEquatable<ExpiredInboxRecordProjection>, IValidatableObject
    {
        ...
        public ExpiredInboxRecordProjection(Guid id = default(Guid), DateTime createdAt = default(DateTime), Guid userId = default(Guid), string emailAddress = default(string))
        {
            this.Id = id;
