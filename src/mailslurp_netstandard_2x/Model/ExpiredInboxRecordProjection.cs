...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class ExpiredInboxRecordProjection : IEquatable<ExpiredInboxRecordProjection>, IValidatableObject
    {
        ...
        public ExpiredInboxRecordProjection(string emailAddress = default(string), Guid userId = default(Guid), DateTime createdAt = default(DateTime), Guid id = default(Guid))
        {
