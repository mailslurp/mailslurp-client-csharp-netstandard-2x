...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class InboxForwarderEventProjection : IEquatable<InboxForwarderEventProjection>, IValidatableObject
    {
        ...
        public InboxForwarderEventProjection(Guid? userId = default(Guid?), Guid? emailId = default(Guid?), Guid? inboxId = default(Guid?), Guid? forwarderId = default(Guid?), DateTime createdAt = default(DateTime), string message = default(string), Guid? id = default(Guid?), StatusEnum? status = default(StatusEnum?))
        {
