...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class EmailVerificationResult : IEquatable<EmailVerificationResult>, IValidatableObject
    {
        ...
        public EmailVerificationResult(string domainName = default(string), int port = default(int), string emailAddress = default(string), string error = default(string), bool valid = default(bool))
        {
