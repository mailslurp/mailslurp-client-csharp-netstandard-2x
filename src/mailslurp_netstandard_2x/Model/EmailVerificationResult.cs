...
namespace mailslurp_netstandard_2x.Model
{
    ...
    public partial class EmailVerificationResult : IEquatable<EmailVerificationResult>, IValidatableObject
    {
        ...
        public EmailVerificationResult(string domainName = default(string), string emailAddress = default(string), string error = default(string), bool isValid = default(bool), int port = default(int))
        {
        ...
        /// </summary>
        [DataMember(Name = "isValid", IsRequired = true, EmitDefaultValue = false)]
