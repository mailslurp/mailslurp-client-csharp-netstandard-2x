...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public interface IMissedEmailControllerApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MissedEmail</returns>
        System.Threading.Tasks.Task<MissedEmail> WaitForNthMissedEmailAsync(Guid inboxId, long timeout, int? index = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MissedEmail)</returns>
        System.Threading.Tasks.Task<ApiResponse<MissedEmail>> WaitForNthMissedEmailWithHttpInfoAsync(Guid inboxId, long timeout, int? index = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class MissedEmailControllerApi : IMissedEmailControllerApi
    {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<MissedEmail> localVarResponse = WaitForNthMissedEmailWithHttpInfo(inboxId, timeout, index);
            return localVarResponse.Data;
        }
        ...
        /// <param name="index">Zero based index of the email to wait for. If 1 missed email already and you want to wait for the 2nd email pass index&#x3D;1 (optional)</param>
        /// <returns>ApiResponse of MissedEmail</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<MissedEmail> WaitForNthMissedEmailWithHttpInfo(Guid inboxId, long timeout, int? index = default(int?))
        {
            mailslurp_netstandard_2x.Client.RequestOptions localVarRequestOptions = new mailslurp_netstandard_2x.Client.RequestOptions();
            ...
            localVarRequestOptions.PathParameters.Add("timeout", mailslurp_netstandard_2x.Client.ClientUtils.ParameterToString(timeout)); // path parameter
            if (index != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MissedEmail</returns>
        public async System.Threading.Tasks.Task<MissedEmail> WaitForNthMissedEmailAsync(Guid inboxId, long timeout, int? index = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            mailslurp_netstandard_2x.Client.ApiResponse<MissedEmail> localVarResponse = await WaitForNthMissedEmailWithHttpInfoAsync(inboxId, timeout, index, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (MissedEmail)</returns>
        public async System.Threading.Tasks.Task<mailslurp_netstandard_2x.Client.ApiResponse<MissedEmail>> WaitForNthMissedEmailWithHttpInfoAsync(Guid inboxId, long timeout, int? index = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
