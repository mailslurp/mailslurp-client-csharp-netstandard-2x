...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public partial class WebhookControllerApi : IWebhookControllerApi
    {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageWebhookProjection> localVarResponse = GetAllWebhooksWithHttpInfo(page, size, sort, searchFilter, since, before);
            return localVarResponse.Data;
        }
        ...
        /// <param name="before">Filter by created at before the given timestamp (optional)</param>
        /// <returns>ApiResponse of PageWebhookProjection</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<PageWebhookProjection> GetAllWebhooksWithHttpInfo(int? page = default(int?), int? size = default(int?), string sort = default(string), string searchFilter = default(string), DateTime? since = default(DateTime?), DateTime? before = default(DateTime?))
        {
            mailslurp_netstandard_2x.Client.RequestOptions localVarRequestOptions = new mailslurp_netstandard_2x.Client.RequestOptions();
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageWebhookProjection> localVarResponse = await GetAllWebhooksWithHttpInfoAsync(page, size, sort, searchFilter, since, before, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
