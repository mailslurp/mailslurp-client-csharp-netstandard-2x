...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public partial class WebhookControllerApi : IWebhookControllerApi
    {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageWebhookResult> localVarResponse = await GetAllWebhookResultsWithHttpInfoAsync(page, size, sort, searchFilter, since, before, unseenOnly, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageWebhookResult> localVarResponse = await GetWebhookResultsWithHttpInfoAsync(webhookId, page, size, sort, searchFilter, since, before, unseenOnly, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
