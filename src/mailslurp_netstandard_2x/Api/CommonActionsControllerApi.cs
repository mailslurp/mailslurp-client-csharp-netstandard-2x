...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public partial class CommonActionsControllerApi : ICommonActionsControllerApi
    {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<InboxDto> localVarResponse = CreateNewEmailAddressWithHttpInfo(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress, domainName, domainId, prefix);
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<InboxDto> localVarResponse = CreateRandomInboxWithHttpInfo(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress, domainName, domainId, prefix);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<Object> SendEmailQueryWithHttpInfo(string to, Guid? senderId = default(Guid?), string body = default(string), string subject = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'to' is set
            if (to == null)
            {
                throw new mailslurp_netstandard_2x.Client.ApiException(400, "Missing required parameter 'to' when calling CommonActionsControllerApi->SendEmailQuery");
            }
            ...
            if (senderId != null)
            {
                localVarRequestOptions.QueryParameters.Add(mailslurp_netstandard_2x.Client.ClientUtils.ParameterToMultiMap("", "senderId", senderId));
            }
            localVarRequestOptions.QueryParameters.Add(mailslurp_netstandard_2x.Client.ClientUtils.ParameterToMultiMap("", "to", to));
            if (body != null)
            {
                localVarRequestOptions.QueryParameters.Add(mailslurp_netstandard_2x.Client.ClientUtils.ParameterToMultiMap("", "body", body));
            }
            if (subject != null)
            {
                localVarRequestOptions.QueryParameters.Add(mailslurp_netstandard_2x.Client.ClientUtils.ParameterToMultiMap("", "subject", subject));
            }
