...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public partial class CommonActionsControllerApi : ICommonActionsControllerApi
    {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<InboxDto> localVarResponse = CreateNewEmailAddressWithHttpInfo(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress, domainName, domainId);
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<InboxDto> localVarResponse = CreateRandomInboxWithHttpInfo(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress, domainName, domainId);
            return localVarResponse.Data;
        }
