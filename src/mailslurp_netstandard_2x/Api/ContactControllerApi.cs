...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public interface IContactControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PageContactProjection> GetAllContactsAsync(int? page = default(int?), int? size = default(int?), string sort = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<PageContactProjection>> GetAllContactsWithHttpInfoAsync(int? page = default(int?), int? size = default(int?), string sort = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get contact
        /// </summary>
        /// <remarks>
    ...
    public partial class ContactControllerApi : IContactControllerApi
    {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageContactProjection> localVarResponse = GetAllContactsWithHttpInfo(page, size, sort);
            return localVarResponse.Data;
        }
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>ApiResponse of PageContactProjection</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<PageContactProjection> GetAllContactsWithHttpInfo(int? page = default(int?), int? size = default(int?), string sort = default(string))
        {
            mailslurp_netstandard_2x.Client.RequestOptions localVarRequestOptions = new mailslurp_netstandard_2x.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PageContactProjection</returns>
        public async System.Threading.Tasks.Task<PageContactProjection> GetAllContactsAsync(int? page = default(int?), int? size = default(int?), string sort = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageContactProjection> localVarResponse = await GetAllContactsWithHttpInfoAsync(page, size, sort, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
