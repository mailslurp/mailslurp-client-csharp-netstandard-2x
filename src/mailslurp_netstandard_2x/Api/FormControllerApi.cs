...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public interface IFormControllerApiSync : IApiAccessor
    {
        ...
        string SubmitForm(string emailAddress = default(string), string redirectTo = default(string), string spamCheck = default(string), string subject = default(string), string successMessage = default(string), string to = default(string), string otherParameters = default(string));
        ...
        ApiResponse<string> SubmitFormWithHttpInfo(string emailAddress = default(string), string redirectTo = default(string), string spamCheck = default(string), string subject = default(string), string successMessage = default(string), string to = default(string), string otherParameters = default(string));
    ...
    public interface IFormControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<string>> SubmitFormWithHttpInfoAsync(string emailAddress = default(string), string redirectTo = default(string), string spamCheck = default(string), string subject = default(string), string successMessage = default(string), string to = default(string), string otherParameters = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class FormControllerApi : IFormControllerApi
    {
        ...
        /// <returns></returns>
        public FormControllerApi(mailslurp_netstandard_2x.Client.Configuration configuration)
        {
        ...
        public FormControllerApi(mailslurp_netstandard_2x.Client.ISynchronousClient client, mailslurp_netstandard_2x.Client.IAsynchronousClient asyncClient, mailslurp_netstandard_2x.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="otherParameters">All other parameters or fields will be accepted and attached to the sent email. This includes files and any HTML form field with a name. These fields will become the body of the email that is sent. (optional)</param>
        /// <returns>string</returns>
        public string SubmitForm(string emailAddress = default(string), string redirectTo = default(string), string spamCheck = default(string), string subject = default(string), string successMessage = default(string), string to = default(string), string otherParameters = default(string))
        {
            mailslurp_netstandard_2x.Client.ApiResponse<string> localVarResponse = SubmitFormWithHttpInfo(emailAddress, redirectTo, spamCheck, subject, successMessage, to, otherParameters);
        ...
        public mailslurp_netstandard_2x.Client.ApiResponse<string> SubmitFormWithHttpInfo(string emailAddress = default(string), string redirectTo = default(string), string spamCheck = default(string), string subject = default(string), string successMessage = default(string), string to = default(string), string otherParameters = default(string))
        {
            ...
            {
                localVarRequestOptions.FormParameters.Add("_emailAddress", mailslurp_netstandard_2x.Client.ClientUtils.ParameterToString(emailAddress)); // form parameter
            }
            if (redirectTo != null)
            {
                localVarRequestOptions.FormParameters.Add("_redirectTo", mailslurp_netstandard_2x.Client.ClientUtils.ParameterToString(redirectTo)); // form parameter
            }
            if (spamCheck != null)
            {
                localVarRequestOptions.FormParameters.Add("_spamCheck", mailslurp_netstandard_2x.Client.ClientUtils.ParameterToString(spamCheck)); // form parameter
            }
            if (subject != null)
            {
                localVarRequestOptions.FormParameters.Add("_subject", mailslurp_netstandard_2x.Client.ClientUtils.ParameterToString(subject)); // form parameter
            }
            if (successMessage != null)
            {
                localVarRequestOptions.FormParameters.Add("_successMessage", mailslurp_netstandard_2x.Client.ClientUtils.ParameterToString(successMessage)); // form parameter
            }
            if (to != null)
            {
                localVarRequestOptions.FormParameters.Add("_to", mailslurp_netstandard_2x.Client.ClientUtils.ParameterToString(to)); // form parameter
            }
            if (otherParameters != null)
            {
                localVarRequestOptions.FormParameters.Add("otherParameters", mailslurp_netstandard_2x.Client.ClientUtils.ParameterToString(otherParameters)); // form parameter
            }
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<string> localVarResponse = await SubmitFormWithHttpInfoAsync(emailAddress, redirectTo, spamCheck, subject, successMessage, to, otherParameters, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
