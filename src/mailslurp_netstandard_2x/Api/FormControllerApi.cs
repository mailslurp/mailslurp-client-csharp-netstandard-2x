...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public interface IFormControllerApiSync : IApiAccessor
    {
        ...
        string SubmitForm(string to = default(string), string subject = default(string), string redirectTo = default(string), string emailAddress = default(string), string successMessage = default(string), string spamCheck = default(string), string otherParameters = default(string));
        ...
        ApiResponse<string> SubmitFormWithHttpInfo(string to = default(string), string subject = default(string), string redirectTo = default(string), string emailAddress = default(string), string successMessage = default(string), string spamCheck = default(string), string otherParameters = default(string));
    ...
    public partial class FormControllerApi : IFormControllerApi
    {
        ...
        /// <param name="otherParameters">All other parameters or fields will be accepted and attached to the sent email. This includes files and any HTML form field with a name. These fields will become the body of the email that is sent. (optional)</param>
        /// <returns>string</returns>
        public string SubmitForm(string to = default(string), string subject = default(string), string redirectTo = default(string), string emailAddress = default(string), string successMessage = default(string), string spamCheck = default(string), string otherParameters = default(string))
        {
            mailslurp_netstandard_2x.Client.ApiResponse<string> localVarResponse = SubmitFormWithHttpInfo(to, subject, redirectTo, emailAddress, successMessage, spamCheck, otherParameters);
        ...
        public mailslurp_netstandard_2x.Client.ApiResponse<string> SubmitFormWithHttpInfo(string to = default(string), string subject = default(string), string redirectTo = default(string), string emailAddress = default(string), string successMessage = default(string), string spamCheck = default(string), string otherParameters = default(string))
        {
            ...
            if (to != null)
            {
                localVarRequestOptions.QueryParameters.Add(mailslurp_netstandard_2x.Client.ClientUtils.ParameterToMultiMap("", "_to", to));
            }
            if (subject != null)
            {
                localVarRequestOptions.QueryParameters.Add(mailslurp_netstandard_2x.Client.ClientUtils.ParameterToMultiMap("", "_subject", subject));
            }
            if (redirectTo != null)
            {
                localVarRequestOptions.QueryParameters.Add(mailslurp_netstandard_2x.Client.ClientUtils.ParameterToMultiMap("", "_redirectTo", redirectTo));
            }
            if (emailAddress != null)
            {
                localVarRequestOptions.QueryParameters.Add(mailslurp_netstandard_2x.Client.ClientUtils.ParameterToMultiMap("", "_emailAddress", emailAddress));
            }
            if (successMessage != null)
            {
                localVarRequestOptions.QueryParameters.Add(mailslurp_netstandard_2x.Client.ClientUtils.ParameterToMultiMap("", "_successMessage", successMessage));
            }
            if (spamCheck != null)
            {
                localVarRequestOptions.QueryParameters.Add(mailslurp_netstandard_2x.Client.ClientUtils.ParameterToMultiMap("", "_spamCheck", spamCheck));
            }
            if (otherParameters != null)
            {
                localVarRequestOptions.QueryParameters.Add(mailslurp_netstandard_2x.Client.ClientUtils.ParameterToMultiMap("", "otherParameters", otherParameters));
            }
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<string> localVarResponse = await SubmitFormWithHttpInfoAsync(to, subject, redirectTo, emailAddress, successMessage, spamCheck, otherParameters, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
