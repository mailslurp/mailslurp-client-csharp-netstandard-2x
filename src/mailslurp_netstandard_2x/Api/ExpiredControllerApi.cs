...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public interface IExpiredControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<ApiResponse<PageExpiredInboxRecordProjection>> GetExpiredInboxesWithHttpInfoAsync(DateTime? before = default(DateTime?), int? page = default(int?), DateTime? since = default(DateTime?), int? size = default(int?), string sort = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class ExpiredControllerApi : IExpiredControllerApi
    {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageExpiredInboxRecordProjection> localVarResponse = GetExpiredInboxesWithHttpInfo(before, page, since, size, sort);
            return localVarResponse.Data;
        }
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>ApiResponse of PageExpiredInboxRecordProjection</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<PageExpiredInboxRecordProjection> GetExpiredInboxesWithHttpInfo(DateTime? before = default(DateTime?), int? page = default(int?), DateTime? since = default(DateTime?), int? size = default(int?), string sort = default(string))
        {
            mailslurp_netstandard_2x.Client.RequestOptions localVarRequestOptions = new mailslurp_netstandard_2x.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PageExpiredInboxRecordProjection</returns>
        public async System.Threading.Tasks.Task<PageExpiredInboxRecordProjection> GetExpiredInboxesAsync(DateTime? before = default(DateTime?), int? page = default(int?), DateTime? since = default(DateTime?), int? size = default(int?), string sort = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageExpiredInboxRecordProjection> localVarResponse = await GetExpiredInboxesWithHttpInfoAsync(before, page, since, size, sort, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
