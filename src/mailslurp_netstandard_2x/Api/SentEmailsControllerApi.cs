...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public interface ISentEmailsControllerApiSync : IApiAccessor
    {
        ...
        /// <exception cref="mailslurp_netstandard_2x.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="deliveryId"></param>
        /// <returns>ApiResponse of DeliveryStatus</returns>
        ApiResponse<DeliveryStatus> GetSentDeliveryStatusWithHttpInfo(Guid deliveryId);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public interface ISentEmailsControllerApiAsync : IApiAccessor
    {
        ...
        /// <param name="deliveryId"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DeliveryStatus</returns>
        System.Threading.Tasks.Task<DeliveryStatus> GetSentDeliveryStatusAsync(Guid deliveryId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="deliveryId"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DeliveryStatus)</returns>
        System.Threading.Tasks.Task<ApiResponse<DeliveryStatus>> GetSentDeliveryStatusWithHttpInfoAsync(Guid deliveryId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class SentEmailsControllerApi : ISentEmailsControllerApi
    {
        ...
        /// <param name="deliveryId"></param>
        /// <returns>DeliveryStatus</returns>
        public DeliveryStatus GetSentDeliveryStatus(Guid deliveryId)
        {
            mailslurp_netstandard_2x.Client.ApiResponse<DeliveryStatus> localVarResponse = GetSentDeliveryStatusWithHttpInfo(deliveryId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="deliveryId"></param>
        /// <returns>ApiResponse of DeliveryStatus</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<DeliveryStatus> GetSentDeliveryStatusWithHttpInfo(Guid deliveryId)
        {
            mailslurp_netstandard_2x.Client.RequestOptions localVarRequestOptions = new mailslurp_netstandard_2x.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get<DeliveryStatus>("/sent/delivery-status/{deliveryId}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DeliveryStatus</returns>
        public async System.Threading.Tasks.Task<DeliveryStatus> GetSentDeliveryStatusAsync(Guid deliveryId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            mailslurp_netstandard_2x.Client.ApiResponse<DeliveryStatus> localVarResponse = await GetSentDeliveryStatusWithHttpInfoAsync(deliveryId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DeliveryStatus)</returns>
        public async System.Threading.Tasks.Task<mailslurp_netstandard_2x.Client.ApiResponse<DeliveryStatus>> GetSentDeliveryStatusWithHttpInfoAsync(Guid deliveryId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<DeliveryStatus>("/sent/delivery-status/{deliveryId}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
