...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public partial class InboxControllerApi : IInboxControllerApi
    {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<InboxDto> localVarResponse = CreateInboxWithHttpInfo(emailAddress, tags, name, description, useDomainPool, favourite, expiresAt, expiresIn, allowTeamAccess, inboxType, virtualInbox, useShortAddress, domainId, domainName);
            return localVarResponse.Data;
        }
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<InboxDto> localVarResponse = await CreateInboxWithHttpInfoAsync(emailAddress, tags, name, description, useDomainPool, favourite, expiresAt, expiresIn, allowTeamAccess, inboxType, virtualInbox, useShortAddress, domainId, domainName, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
