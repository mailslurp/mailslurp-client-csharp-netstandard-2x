...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public partial class UserControllerApi : IUserControllerApi
    {
        ...
        /// <returns></returns>
        public UserControllerApi(mailslurp_netstandard_2x.Client.Configuration configuration)
        {
        ...
        public UserControllerApi(mailslurp_netstandard_2x.Client.ISynchronousClient client, mailslurp_netstandard_2x.Client.IAsynchronousClient asyncClient, mailslurp_netstandard_2x.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of string</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<string> GetJsonPropertyAsStringWithHttpInfo(string property, Object body, int operationIndex = 0)
        {
            // verify the required parameter 'property' is set
            if (property == null)
            {
                throw new mailslurp_netstandard_2x.Client.ApiException(400, "Missing required parameter 'property' when calling UserControllerApi->GetJsonPropertyAsString");
            }

            // verify the required parameter 'body' is set
            if (body == null)
            {
                throw new mailslurp_netstandard_2x.Client.ApiException(400, "Missing required parameter 'body' when calling UserControllerApi->GetJsonPropertyAsString");
            }
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<string> localVarResponse = await GetJsonPropertyAsStringWithHttpInfoAsync(property, body, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<mailslurp_netstandard_2x.Client.ApiResponse<string>> GetJsonPropertyAsStringWithHttpInfoAsync(string property, Object body, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'property' is set
            if (property == null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of UserInfoDto</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<UserInfoDto> GetUserInfoWithHttpInfo(int operationIndex = 0)
        {
            mailslurp_netstandard_2x.Client.RequestOptions localVarRequestOptions = new mailslurp_netstandard_2x.Client.RequestOptions();
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<UserInfoDto> localVarResponse = await GetUserInfoWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (UserInfoDto)</returns>
        public async System.Threading.Tasks.Task<mailslurp_netstandard_2x.Client.ApiResponse<UserInfoDto>> GetUserInfoWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
