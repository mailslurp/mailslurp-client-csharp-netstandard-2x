...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public interface IExportControllerApiSync : IApiAccessor
    {
        ...
        List<byte[]> ExportEntities(string exportType, string apiKey, string outputFormat, string filter = default(string), string listSeparatorToken = default(string), bool? excludePreviouslyExported = default(bool?), DateTime? createdEarliestTime = default(DateTime?), DateTime? createdOldestTime = default(DateTime?));
    ...
    public partial class ExportControllerApi : IExportControllerApi
    {
        ...
        /// <param name="createdOldestTime"> (optional)</param>
        /// <returns>List&lt;byte[]&gt;</returns>
        public List<byte[]> ExportEntities(string exportType, string apiKey, string outputFormat, string filter = default(string), string listSeparatorToken = default(string), bool? excludePreviouslyExported = default(bool?), DateTime? createdEarliestTime = default(DateTime?), DateTime? createdOldestTime = default(DateTime?))
        {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<List<byte[]>> localVarResponse = await ExportEntitiesWithHttpInfoAsync(exportType, apiKey, outputFormat, filter, listSeparatorToken, excludePreviouslyExported, createdEarliestTime, createdOldestTime, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
