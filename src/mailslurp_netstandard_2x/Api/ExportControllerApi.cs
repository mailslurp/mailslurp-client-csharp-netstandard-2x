...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public interface IExportControllerApiSync : IApiAccessor
    {
        ...
        List<byte[]> ExportEntities(string exportType, string apiKey, string outputFormat, string filter = default(string), string listSeparatorToken = default(string), bool? excludePreviouslyExported = default(bool?), DateTime? createdEarliestTime = default(DateTime?), DateTime? createdOldestTime = default(DateTime?), int operationIndex = 0);
        ...
        ApiResponse<List<byte[]>> ExportEntitiesWithHttpInfo(string exportType, string apiKey, string outputFormat, string filter = default(string), string listSeparatorToken = default(string), bool? excludePreviouslyExported = default(bool?), DateTime? createdEarliestTime = default(DateTime?), DateTime? createdOldestTime = default(DateTime?), int operationIndex = 0);
        /// <summary>
        /// Get export link
        /// </summary>
        /// <exception cref="mailslurp_netstandard_2x.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    public interface IExportControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<byte[]>> ExportEntitiesAsync(string exportType, string apiKey, string outputFormat, string filter = default(string), string listSeparatorToken = default(string), bool? excludePreviouslyExported = default(bool?), DateTime? createdEarliestTime = default(DateTime?), DateTime? createdOldestTime = default(DateTime?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<byte[]>>> ExportEntitiesWithHttpInfoAsync(string exportType, string apiKey, string outputFormat, string filter = default(string), string listSeparatorToken = default(string), bool? excludePreviouslyExported = default(bool?), DateTime? createdEarliestTime = default(DateTime?), DateTime? createdOldestTime = default(DateTime?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get export link
        /// </summary>
        /// <remarks>
    ...
    public partial class ExportControllerApi : IExportControllerApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;byte[]&gt;</returns>
        public List<byte[]> ExportEntities(string exportType, string apiKey, string outputFormat, string filter = default(string), string listSeparatorToken = default(string), bool? excludePreviouslyExported = default(bool?), DateTime? createdEarliestTime = default(DateTime?), DateTime? createdOldestTime = default(DateTime?), int operationIndex = 0)
        {
            mailslurp_netstandard_2x.Client.ApiResponse<List<byte[]>> localVarResponse = ExportEntitiesWithHttpInfo(exportType, apiKey, outputFormat, filter, listSeparatorToken, excludePreviouslyExported, createdEarliestTime, createdOldestTime);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;byte[]&gt;</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<List<byte[]>> ExportEntitiesWithHttpInfo(string exportType, string apiKey, string outputFormat, string filter = default(string), string listSeparatorToken = default(string), bool? excludePreviouslyExported = default(bool?), DateTime? createdEarliestTime = default(DateTime?), DateTime? createdOldestTime = default(DateTime?), int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Get<List<byte[]>>("/export", localVarRequestOptions, this.Configuration);
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<List<byte[]>> localVarResponse = await ExportEntitiesWithHttpInfoAsync(exportType, apiKey, outputFormat, filter, listSeparatorToken, excludePreviouslyExported, createdEarliestTime, createdOldestTime, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;byte[]&gt;)</returns>
        public async System.Threading.Tasks.Task<mailslurp_netstandard_2x.Client.ApiResponse<List<byte[]>>> ExportEntitiesWithHttpInfoAsync(string exportType, string apiKey, string outputFormat, string filter = default(string), string listSeparatorToken = default(string), bool? excludePreviouslyExported = default(bool?), DateTime? createdEarliestTime = default(DateTime?), DateTime? createdOldestTime = default(DateTime?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'exportType' is set
            if (exportType == null)
            {
            ...
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<byte[]>>("/export", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ExportLink</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<ExportLink> GetExportLinkWithHttpInfo(string exportType, ExportOptions exportOptions, string apiKey = default(string), int operationIndex = 0)
        {
            // verify the required parameter 'exportType' is set
            if (exportType == null)
            {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<ExportLink> localVarResponse = await GetExportLinkWithHttpInfoAsync(exportType, exportOptions, apiKey, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (ExportLink)</returns>
        public async System.Threading.Tasks.Task<mailslurp_netstandard_2x.Client.ApiResponse<ExportLink>> GetExportLinkWithHttpInfoAsync(string exportType, ExportOptions exportOptions, string apiKey = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'exportType' is set
            if (exportType == null)
            {
