...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public partial class AttachmentControllerApi : IAttachmentControllerApi
    {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<List<string>> localVarResponse = UploadAttachmentBytesWithHttpInfo(contentType, contentType2, contentId, filename, filename2);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;string&gt;</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<List<string>> UploadAttachmentBytesWithHttpInfo(string contentType = default(string), string contentType2 = default(string), string contentId = default(string), string filename = default(string), string filename2 = default(string), int operationIndex = 0)
        {
            mailslurp_netstandard_2x.Client.RequestOptions localVarRequestOptions = new mailslurp_netstandard_2x.Client.RequestOptions();
            ...
            {
                localVarRequestOptions.QueryParameters.Add(mailslurp_netstandard_2x.Client.ClientUtils.ParameterToMultiMap("", "contentType", contentType2));
            }
            if (contentId != null)
            {
                localVarRequestOptions.QueryParameters.Add(mailslurp_netstandard_2x.Client.ClientUtils.ParameterToMultiMap("", "contentId", contentId));
            }
            if (filename != null)
            {
            ...
            if (filename2 != null)
            {
                localVarRequestOptions.HeaderParameters.Add("filename", mailslurp_netstandard_2x.Client.ClientUtils.ParameterToString(filename2)); // header parameter
            }
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<List<string>> localVarResponse = await UploadAttachmentBytesWithHttpInfoAsync(contentType, contentType2, contentId, filename, filename2, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<List<string>> localVarResponse = UploadMultipartFormWithHttpInfo(contentId, contentType, filename, xFilename, uploadMultipartFormRequest);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<List<string>> UploadMultipartFormAsync(string contentId = default(string), string contentType = default(string), string filename = default(string), string xFilename = default(string), UploadMultipartFormRequest uploadMultipartFormRequest = default(UploadMultipartFormRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            mailslurp_netstandard_2x.Client.ApiResponse<List<string>> localVarResponse = await UploadMultipartFormWithHttpInfoAsync(contentId, contentType, filename, xFilename, uploadMultipartFormRequest, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;string&gt;)</returns>
        public async System.Threading.Tasks.Task<mailslurp_netstandard_2x.Client.ApiResponse<List<string>>> UploadMultipartFormWithHttpInfoAsync(string contentId = default(string), string contentType = default(string), string filename = default(string), string xFilename = default(string), UploadMultipartFormRequest uploadMultipartFormRequest = default(UploadMultipartFormRequest), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
