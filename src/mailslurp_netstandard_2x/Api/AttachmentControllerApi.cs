...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public partial class AttachmentControllerApi : IAttachmentControllerApi
    {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageAttachmentEntity> localVarResponse = GetAttachmentsWithHttpInfo(page, size, sort, fileNameFilter, since, before, inboxId);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PageAttachmentEntity</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<PageAttachmentEntity> GetAttachmentsWithHttpInfo(int? page = default(int?), int? size = default(int?), string sort = default(string), string fileNameFilter = default(string), DateTime? since = default(DateTime?), DateTime? before = default(DateTime?), Guid? inboxId = default(Guid?), int operationIndex = 0)
        {
            mailslurp_netstandard_2x.Client.RequestOptions localVarRequestOptions = new mailslurp_netstandard_2x.Client.RequestOptions();
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageAttachmentEntity> localVarResponse = await GetAttachmentsWithHttpInfoAsync(page, size, sort, fileNameFilter, since, before, inboxId, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
