...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public interface IInboxRulesetControllerApiSync : IApiAccessor
    {
        ...
        PageInboxRulesetDto GetInboxRulesets(Guid? inboxId = default(Guid?), int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string));
        ...
        ApiResponse<PageInboxRulesetDto> GetInboxRulesetsWithHttpInfo(Guid? inboxId = default(Guid?), int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string));
        /// <summary>
    ...
    public interface IInboxRulesetControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PageInboxRulesetDto> GetInboxRulesetsAsync(Guid? inboxId = default(Guid?), int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class InboxRulesetControllerApi : IInboxRulesetControllerApi
    {
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>PageInboxRulesetDto</returns>
        public PageInboxRulesetDto GetInboxRulesets(Guid? inboxId = default(Guid?), int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string))
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageInboxRulesetDto> localVarResponse = GetInboxRulesetsWithHttpInfo(inboxId, page, searchFilter, size, sort);
            return localVarResponse.Data;
        }
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>ApiResponse of PageInboxRulesetDto</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<PageInboxRulesetDto> GetInboxRulesetsWithHttpInfo(Guid? inboxId = default(Guid?), int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string))
        {
            mailslurp_netstandard_2x.Client.RequestOptions localVarRequestOptions = new mailslurp_netstandard_2x.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PageInboxRulesetDto</returns>
        public async System.Threading.Tasks.Task<PageInboxRulesetDto> GetInboxRulesetsAsync(Guid? inboxId = default(Guid?), int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageInboxRulesetDto> localVarResponse = await GetInboxRulesetsWithHttpInfoAsync(inboxId, page, searchFilter, size, sort, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
