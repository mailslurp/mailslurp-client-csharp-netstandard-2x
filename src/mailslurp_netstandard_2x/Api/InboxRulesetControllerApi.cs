...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public partial class InboxRulesetControllerApi : IInboxRulesetControllerApi
    {
        ...
        /// <param name="createInboxRulesetOptions"></param>
        /// <returns>ApiResponse of InboxRulesetDto</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<InboxRulesetDto> CreateNewInboxRulesetWithHttpInfo(Guid inboxId, CreateInboxRulesetOptions createInboxRulesetOptions)
        {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<InboxRulesetDto> localVarResponse = await CreateNewInboxRulesetWithHttpInfoAsync(inboxId, createInboxRulesetOptions, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InboxRulesetDto)</returns>
        public async System.Threading.Tasks.Task<mailslurp_netstandard_2x.Client.ApiResponse<InboxRulesetDto>> CreateNewInboxRulesetWithHttpInfoAsync(Guid inboxId, CreateInboxRulesetOptions createInboxRulesetOptions, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'createInboxRulesetOptions' is set
            if (createInboxRulesetOptions == null)
                throw new mailslurp_netstandard_2x.Client.ApiException(400, "Missing required parameter 'createInboxRulesetOptions' when calling InboxRulesetControllerApi->CreateNewInboxRuleset");
        ...
        /// <param name="before">Filter by created at before the given timestamp (optional)</param>
        /// <returns>ApiResponse of PageInboxRulesetDto</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<PageInboxRulesetDto> GetInboxRulesetsWithHttpInfo(Guid? inboxId = default(Guid?), int? page = default(int?), int? size = default(int?), string sort = default(string), string searchFilter = default(string), DateTime? since = default(DateTime?), DateTime? before = default(DateTime?))
        {
            mailslurp_netstandard_2x.Client.RequestOptions localVarRequestOptions = new mailslurp_netstandard_2x.Client.RequestOptions();
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageInboxRulesetDto> localVarResponse = await GetInboxRulesetsWithHttpInfoAsync(inboxId, page, size, sort, searchFilter, since, before, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
