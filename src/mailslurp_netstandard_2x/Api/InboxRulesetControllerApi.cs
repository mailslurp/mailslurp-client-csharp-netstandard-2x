...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public interface IInboxRulesetControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PageInboxRulesetProjection> GetInboxRulesetsAsync(Guid? inboxId = default(Guid?), int? page = default(int?), int? size = default(int?), string sort = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<PageInboxRulesetProjection>> GetInboxRulesetsWithHttpInfoAsync(Guid? inboxId = default(Guid?), int? page = default(int?), int? size = default(int?), string sort = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class InboxRulesetControllerApi : IInboxRulesetControllerApi
    {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageInboxRulesetProjection> localVarResponse = GetInboxRulesetsWithHttpInfo(inboxId, page, size, sort);
            return localVarResponse.Data;
        }
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>ApiResponse of PageInboxRulesetProjection</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<PageInboxRulesetProjection> GetInboxRulesetsWithHttpInfo(Guid? inboxId = default(Guid?), int? page = default(int?), int? size = default(int?), string sort = default(string))
        {
            mailslurp_netstandard_2x.Client.RequestOptions localVarRequestOptions = new mailslurp_netstandard_2x.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PageInboxRulesetProjection</returns>
        public async System.Threading.Tasks.Task<PageInboxRulesetProjection> GetInboxRulesetsAsync(Guid? inboxId = default(Guid?), int? page = default(int?), int? size = default(int?), string sort = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageInboxRulesetProjection> localVarResponse = await GetInboxRulesetsWithHttpInfoAsync(inboxId, page, size, sort, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<mailslurp_netstandard_2x.Client.ApiResponse<PageInboxRulesetProjection>> GetInboxRulesetsWithHttpInfoAsync(Guid? inboxId = default(Guid?), int? page = default(int?), int? size = default(int?), string sort = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<PageInboxRulesetProjection>("/rulesets", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
