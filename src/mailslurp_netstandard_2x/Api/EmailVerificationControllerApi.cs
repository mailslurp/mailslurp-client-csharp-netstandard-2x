...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public partial class EmailVerificationControllerApi : IEmailVerificationControllerApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<Object> DeleteAllValidationRequestsWithHttpInfo(int operationIndex = 0)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<mailslurp_netstandard_2x.Client.ApiResponse<Object>> DeleteAllValidationRequestsWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<Object> DeleteValidationRequestWithHttpInfo(Guid id, int operationIndex = 0)
        {
            mailslurp_netstandard_2x.Client.RequestOptions localVarRequestOptions = new mailslurp_netstandard_2x.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<mailslurp_netstandard_2x.Client.ApiResponse<Object>> DeleteValidationRequestWithHttpInfoAsync(Guid id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageEmailValidationRequest> localVarResponse = await GetValidationRequestsWithHttpInfoAsync(page, size, sort, searchFilter, since, before, isValid, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of ValidateEmailAddressListResult</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<ValidateEmailAddressListResult> ValidateEmailAddressListWithHttpInfo(ValidateEmailAddressListOptions validateEmailAddressListOptions, int operationIndex = 0)
        {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<ValidateEmailAddressListResult> localVarResponse = await ValidateEmailAddressListWithHttpInfoAsync(validateEmailAddressListOptions, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
