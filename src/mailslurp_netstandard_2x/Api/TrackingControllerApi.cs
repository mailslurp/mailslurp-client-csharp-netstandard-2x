...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public interface ITrackingControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PageTrackingPixelProjection> GetAllTrackingPixelsAsync(DateTime? before = default(DateTime?), int? page = default(int?), string searchFilter = default(string), DateTime? since = default(DateTime?), int? size = default(int?), string sort = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<PageTrackingPixelProjection>> GetAllTrackingPixelsWithHttpInfoAsync(DateTime? before = default(DateTime?), int? page = default(int?), string searchFilter = default(string), DateTime? since = default(DateTime?), int? size = default(int?), string sort = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get pixel
        /// </summary>
        /// <remarks>
    ...
    public partial class TrackingControllerApi : ITrackingControllerApi
    {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageTrackingPixelProjection> localVarResponse = GetAllTrackingPixelsWithHttpInfo(before, page, searchFilter, since, size, sort);
            return localVarResponse.Data;
        }
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>ApiResponse of PageTrackingPixelProjection</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<PageTrackingPixelProjection> GetAllTrackingPixelsWithHttpInfo(DateTime? before = default(DateTime?), int? page = default(int?), string searchFilter = default(string), DateTime? since = default(DateTime?), int? size = default(int?), string sort = default(string))
        {
            mailslurp_netstandard_2x.Client.RequestOptions localVarRequestOptions = new mailslurp_netstandard_2x.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PageTrackingPixelProjection</returns>
        public async System.Threading.Tasks.Task<PageTrackingPixelProjection> GetAllTrackingPixelsAsync(DateTime? before = default(DateTime?), int? page = default(int?), string searchFilter = default(string), DateTime? since = default(DateTime?), int? size = default(int?), string sort = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageTrackingPixelProjection> localVarResponse = await GetAllTrackingPixelsWithHttpInfoAsync(before, page, searchFilter, since, size, sort, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
