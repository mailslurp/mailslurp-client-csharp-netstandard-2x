...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public interface ITrackingControllerApiSync : IApiAccessor
    {
        ...
        PageTrackingPixelProjection GetAllTrackingPixels(int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string));
        ...
        ApiResponse<PageTrackingPixelProjection> GetAllTrackingPixelsWithHttpInfo(int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string));
        /// <summary>
        /// Get pixel
        /// </summary>
        /// <exception cref="mailslurp_netstandard_2x.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    public interface ITrackingControllerApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PageTrackingPixelProjection> GetAllTrackingPixelsAsync(int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class TrackingControllerApi : ITrackingControllerApi
    {
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>PageTrackingPixelProjection</returns>
        public PageTrackingPixelProjection GetAllTrackingPixels(int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string))
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageTrackingPixelProjection> localVarResponse = GetAllTrackingPixelsWithHttpInfo(page, searchFilter, size, sort);
            return localVarResponse.Data;
        }
        ...
        /// <param name="sort">Optional createdAt sort direction ASC or DESC (optional, default to ASC)</param>
        /// <returns>ApiResponse of PageTrackingPixelProjection</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<PageTrackingPixelProjection> GetAllTrackingPixelsWithHttpInfo(int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string))
        {
            mailslurp_netstandard_2x.Client.RequestOptions localVarRequestOptions = new mailslurp_netstandard_2x.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PageTrackingPixelProjection</returns>
        public async System.Threading.Tasks.Task<PageTrackingPixelProjection> GetAllTrackingPixelsAsync(int? page = default(int?), string searchFilter = default(string), int? size = default(int?), string sort = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageTrackingPixelProjection> localVarResponse = await GetAllTrackingPixelsWithHttpInfoAsync(page, searchFilter, size, sort, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
