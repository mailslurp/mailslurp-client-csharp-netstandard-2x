...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public partial class TrackingControllerApi : ITrackingControllerApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TrackingPixelDto</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<TrackingPixelDto> CreateTrackingPixelWithHttpInfo(CreateTrackingPixelOptions createTrackingPixelOptions, int operationIndex = 0)
        {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<TrackingPixelDto> localVarResponse = await CreateTrackingPixelWithHttpInfoAsync(createTrackingPixelOptions, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TrackingPixelDto)</returns>
        public async System.Threading.Tasks.Task<mailslurp_netstandard_2x.Client.ApiResponse<TrackingPixelDto>> CreateTrackingPixelWithHttpInfoAsync(CreateTrackingPixelOptions createTrackingPixelOptions, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'createTrackingPixelOptions' is set
            if (createTrackingPixelOptions == null)
            {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageTrackingPixelProjection> localVarResponse = GetAllTrackingPixelsWithHttpInfo(page, size, sort, searchFilter, since, before);
            return localVarResponse.Data;
        }
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageTrackingPixelProjection> localVarResponse = await GetAllTrackingPixelsWithHttpInfoAsync(page, size, sort, searchFilter, since, before, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of TrackingPixelDto</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<TrackingPixelDto> GetTrackingPixelWithHttpInfo(Guid id, int operationIndex = 0)
        {
            mailslurp_netstandard_2x.Client.RequestOptions localVarRequestOptions = new mailslurp_netstandard_2x.Client.RequestOptions();
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<TrackingPixelDto> localVarResponse = await GetTrackingPixelWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (TrackingPixelDto)</returns>
        public async System.Threading.Tasks.Task<mailslurp_netstandard_2x.Client.ApiResponse<TrackingPixelDto>> GetTrackingPixelWithHttpInfoAsync(Guid id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
