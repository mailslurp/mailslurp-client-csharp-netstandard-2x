...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public partial class SmsControllerApi : ISmsControllerApi
    {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<SmsMessage> localVarResponse = GetSmsMessageWithHttpInfo(smsId);
        ...
        /// <param name="smsId"></param>
        /// <returns>ApiResponse of SmsMessage</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<SmsMessage> GetSmsMessageWithHttpInfo(Guid smsId)
        {
            mailslurp_netstandard_2x.Client.RequestOptions localVarRequestOptions = new mailslurp_netstandard_2x.Client.RequestOptions();
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<SmsMessage> localVarResponse = await GetSmsMessageWithHttpInfoAsync(smsId, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SmsMessage)</returns>
        public async System.Threading.Tasks.Task<mailslurp_netstandard_2x.Client.ApiResponse<SmsMessage>> GetSmsMessageWithHttpInfoAsync(Guid smsId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
