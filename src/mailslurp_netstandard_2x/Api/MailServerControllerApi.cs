...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public partial class MailServerControllerApi : IMailServerControllerApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DescribeMailServerDomainResult</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<DescribeMailServerDomainResult> DescribeMailServerDomainWithHttpInfo(DescribeDomainOptions describeDomainOptions, int operationIndex = 0)
        {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<DescribeMailServerDomainResult> localVarResponse = await DescribeMailServerDomainWithHttpInfoAsync(describeDomainOptions, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DNSLookupResults</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<DNSLookupResults> GetDnsLookupWithHttpInfo(DNSLookupOptions dNSLookupOptions, int operationIndex = 0)
        {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<DNSLookupResults> localVarResponse = await GetDnsLookupWithHttpInfoAsync(dNSLookupOptions, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DNSLookupResults)</returns>
        public async System.Threading.Tasks.Task<mailslurp_netstandard_2x.Client.ApiResponse<DNSLookupResults>> GetDnsLookupWithHttpInfoAsync(DNSLookupOptions dNSLookupOptions, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'dNSLookupOptions' is set
            if (dNSLookupOptions == null)
            {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<DNSLookupResults> localVarResponse = GetDnsLookupsWithHttpInfo(dNSLookupsOptions);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DNSLookupResults</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<DNSLookupResults> GetDnsLookupsWithHttpInfo(DNSLookupsOptions dNSLookupsOptions, int operationIndex = 0)
        {
            // verify the required parameter 'dNSLookupsOptions' is set
            if (dNSLookupsOptions == null)
            {
                throw new mailslurp_netstandard_2x.Client.ApiException(400, "Missing required parameter 'dNSLookupsOptions' when calling MailServerControllerApi->GetDnsLookups");
            }
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<DNSLookupResults> localVarResponse = await GetDnsLookupsWithHttpInfoAsync(dNSLookupsOptions, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DNSLookupResults)</returns>
        public async System.Threading.Tasks.Task<mailslurp_netstandard_2x.Client.ApiResponse<DNSLookupResults>> GetDnsLookupsWithHttpInfoAsync(DNSLookupsOptions dNSLookupsOptions, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'dNSLookupsOptions' is set
            if (dNSLookupsOptions == null)
            {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of IPAddressResult</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<IPAddressResult> GetIpAddressWithHttpInfo(string name, int operationIndex = 0)
        {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<IPAddressResult> localVarResponse = await GetIpAddressWithHttpInfoAsync(name, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (IPAddressResult)</returns>
        public async System.Threading.Tasks.Task<mailslurp_netstandard_2x.Client.ApiResponse<IPAddressResult>> GetIpAddressWithHttpInfoAsync(string name, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'name' is set
            if (name == null)
            {
        ...
        /// <returns>ApiResponse of EmailVerificationResult</returns>
        [Obsolete]
        public mailslurp_netstandard_2x.Client.ApiResponse<EmailVerificationResult> VerifyEmailAddressWithHttpInfo(VerifyEmailAddressOptions verifyEmailAddressOptions, int operationIndex = 0)
        {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<EmailVerificationResult> localVarResponse = await VerifyEmailAddressWithHttpInfoAsync(verifyEmailAddressOptions, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <returns>Task of ApiResponse (EmailVerificationResult)</returns>
        [Obsolete]
        public async System.Threading.Tasks.Task<mailslurp_netstandard_2x.Client.ApiResponse<EmailVerificationResult>> VerifyEmailAddressWithHttpInfoAsync(VerifyEmailAddressOptions verifyEmailAddressOptions, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'verifyEmailAddressOptions' is set
            if (verifyEmailAddressOptions == null)
            {
