...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public interface IDomainControllerApiSync : IApiAccessor
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>DomainDto</returns>
        DomainDto GetDomain(Guid id, int operationIndex = 0);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DomainDto</returns>
        ApiResponse<DomainDto> GetDomainWithHttpInfo(Guid id, int operationIndex = 0);
        /// <summary>
    ...
    public interface IDomainControllerApiAsync : IApiAccessor
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DomainDto</returns>
        System.Threading.Tasks.Task<DomainDto> GetDomainAsync(Guid id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DomainDto)</returns>
        System.Threading.Tasks.Task<ApiResponse<DomainDto>> GetDomainWithHttpInfoAsync(Guid id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Get catch all wild card inbox for domain
        /// </summary>
        /// <remarks>
    ...
    public partial class DomainControllerApi : IDomainControllerApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>DomainDto</returns>
        public DomainDto GetDomain(Guid id, int operationIndex = 0)
        {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of DomainDto</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<DomainDto> GetDomainWithHttpInfo(Guid id, int operationIndex = 0)
        {
            mailslurp_netstandard_2x.Client.RequestOptions localVarRequestOptions = new mailslurp_netstandard_2x.Client.RequestOptions();
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of DomainDto</returns>
        public async System.Threading.Tasks.Task<DomainDto> GetDomainAsync(Guid id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            mailslurp_netstandard_2x.Client.ApiResponse<DomainDto> localVarResponse = await GetDomainWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DomainDto)</returns>
        public async System.Threading.Tasks.Task<mailslurp_netstandard_2x.Client.ApiResponse<DomainDto>> GetDomainWithHttpInfoAsync(Guid id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
