...
namespace mailslurp_netstandard_2x.Api
{
    ...
    public partial class InboxForwarderControllerApi : IInboxForwarderControllerApi
    {
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageInboxForwarderEvents> localVarResponse = GetAllInboxForwarderEventsWithHttpInfo(page, size, inboxId, sort);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of PageInboxForwarderEvents</returns>
        public mailslurp_netstandard_2x.Client.ApiResponse<PageInboxForwarderEvents> GetAllInboxForwarderEventsWithHttpInfo(int? page = default(int?), int? size = default(int?), Guid? inboxId = default(Guid?), string sort = default(string), int operationIndex = 0)
        {
            mailslurp_netstandard_2x.Client.RequestOptions localVarRequestOptions = new mailslurp_netstandard_2x.Client.RequestOptions();
        ...
        {
            mailslurp_netstandard_2x.Client.ApiResponse<PageInboxForwarderEvents> localVarResponse = await GetAllInboxForwarderEventsWithHttpInfoAsync(page, size, inboxId, sort, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PageInboxForwarderEvents)</returns>
        public async System.Threading.Tasks.Task<mailslurp_netstandard_2x.Client.ApiResponse<PageInboxForwarderEvents>> GetAllInboxForwarderEventsWithHttpInfoAsync(int? page = default(int?), int? size = default(int?), Guid? inboxId = default(Guid?), string sort = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
