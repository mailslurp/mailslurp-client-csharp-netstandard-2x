...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class InboxForwarderControllerApiTests : IDisposable
    {
        ...
        public void CreateNewInboxForwarderTest()
        {
            ...
            //Guid? inboxId = null;
            //var response = instance.CreateNewInboxForwarder(createInboxForwarderOptions, inboxId);
        ...
        public void GetInboxForwardersTest()
        {
            ...
            //int? size = null;
            //string sort = null;
            //var response = instance.GetInboxForwarders(before, inboxId, page, searchFilter, since, size, sort);
