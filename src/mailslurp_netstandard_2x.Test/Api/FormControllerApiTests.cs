...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class FormControllerApiTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test 'IsType' FormControllerApi
            //Assert.IsType<FormControllerApi>(instance);
        }
        ...
        public void SubmitFormTest()
        {
            ...
            //var response = instance.SubmitForm(to, subject, redirectTo, emailAddress, successMessage, spamCheck, otherParameters);
