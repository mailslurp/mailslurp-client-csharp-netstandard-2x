...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class EmailControllerApiTests : IDisposable
    {
        ...
        public void GetEmailsPaginatedTest()
        {
            ...
            //var response = instance.GetEmailsPaginated(before, inboxId, page, searchFilter, since, size, sort, unreadOnly);
        ...
        public void GetOrganizationEmailsPaginatedTest()
        {
            ...
            //string sort = null;
            //bool? unreadOnly = null;
            //var response = instance.GetOrganizationEmailsPaginated(before, inboxId, page, searchFilter, since, size, sort, unreadOnly);
            //Assert.IsType<PageEmailProjection>(response);
        }
