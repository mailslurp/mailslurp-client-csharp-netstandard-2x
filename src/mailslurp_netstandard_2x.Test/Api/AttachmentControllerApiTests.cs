...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class AttachmentControllerApiTests : IDisposable
    {
        ...
        public void GetAttachmentsTest()
        {
            ...
            //var response = instance.GetAttachments(page, size, sort, fileNameFilter, since, before);
        ...
        public void UploadAttachmentBytesTest()
        {
            ...
            //var response = instance.UploadAttachmentBytes(uploadAttachmentBytesRequest, contentType, filename);
            //Assert.IsType<List<string>>(response);
        }
        ...
        public void UploadMultipartFormTest()
        {
            ...
            //var response = instance.UploadMultipartForm(contentType, filename, xFilename, uploadMultipartFormRequest);
            //Assert.IsType<List<string>>(response);
        }
    }
}
