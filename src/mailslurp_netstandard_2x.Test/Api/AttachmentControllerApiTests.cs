...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class AttachmentControllerApiTests : IDisposable
    {
        ...
        public void GetAttachments1Test()
        {
            ...
            //var response = instance.GetAttachments1(page, size, sort, fileNameFilter, since, before);
        ...
        public void UploadAttachmentBytesTest()
        {
            ...
            //var response = instance.UploadAttachmentBytes(requestBody, contentType, filename);
            //Assert.IsType<List<string>>(response);
        }
