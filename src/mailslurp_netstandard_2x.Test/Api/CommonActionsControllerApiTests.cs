...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class CommonActionsControllerApiTests : IDisposable
    {
        ...
        public void CreateNewEmailAddressTest()
        {
            ...
            //var response = instance.CreateNewEmailAddress(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox);
        ...
        public void CreateRandomInboxTest()
        {
            ...
            //bool? favourite = null;
            //bool? virtualInbox = null;
            //var response = instance.CreateRandomInbox(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox);
            //Assert.IsType<InboxDto>(response);
        }
