...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class CommonActionsControllerApiTests : IDisposable
    {
        ...
        public void CreateNewEmailAddressTest()
        {
            ...
            //var response = instance.CreateNewEmailAddress(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress);
        ...
        public void CreateRandomInboxTest()
        {
            ...
            //bool? virtualInbox = null;
            //bool? useShortAddress = null;
            //var response = instance.CreateRandomInbox(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress);
            //Assert.IsType<InboxDto>(response);
        }
