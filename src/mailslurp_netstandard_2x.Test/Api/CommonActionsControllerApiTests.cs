...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class CommonActionsControllerApiTests : IDisposable
    {
        ...
        public void CreateNewEmailAddressTest()
        {
            ...
            //var response = instance.CreateNewEmailAddress(allowTeamAccess, description, emailAddress, expiresAt, expiresIn, favourite, inboxType, name, tags, useDomainPool);
        ...
        public void CreateNewEmailAddress1Test()
        {
            ...
            //List<string> tags = null;
            //bool? useDomainPool = null;
            //var response = instance.CreateNewEmailAddress1(allowTeamAccess, description, emailAddress, expiresAt, expiresIn, favourite, inboxType, name, tags, useDomainPool);
            //Assert.IsType<Inbox>(response);
        }
