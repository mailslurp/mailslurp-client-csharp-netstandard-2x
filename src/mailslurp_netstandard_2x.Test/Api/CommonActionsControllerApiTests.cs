...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class CommonActionsControllerApiTests : IDisposable
    {
        ...
        public void CreateNewEmailAddressTest()
        {
            ...
            //Guid? domainId = null;
            //var response = instance.CreateNewEmailAddress(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress, domainName, domainId);
        ...
        public void CreateRandomInboxTest()
        {
            ...
            //string domainName = null;
            //Guid? domainId = null;
            //var response = instance.CreateRandomInbox(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite, virtualInbox, useShortAddress, domainName, domainId);
            //Assert.IsType<InboxDto>(response);
        }
