...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class ExpiredControllerApiTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Guid iDOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId = null;
            //var response = instance.GetExpiredInboxRecord(iDOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId);
            //Assert.IsType<ExpiredInboxDto>(response);
        }
