...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class SentEmailsControllerApiTests : IDisposable
    {
        ...
        public void GetAllSentTrackingPixelsTest()
        {
            ...
            //int? size = null;
            //string sort = null;
            //var response = instance.GetAllSentTrackingPixels(before, page, searchFilter, since, size, sort);
        ...
        public void GetSentEmailTrackingPixelsTest()
        {
            ...
            //int? size = null;
            //string sort = null;
            //var response = instance.GetSentEmailTrackingPixels(id, before, page, searchFilter, since, size, sort);
            //Assert.IsType<PageTrackingPixelProjection>(response);
        }
        ...
        public void GetSentEmailsTest()
        {
            ...
            //int? size = null;
            //string sort = null;
            //var response = instance.GetSentEmails(before, inboxId, page, searchFilter, since, size, sort);
        ...
        public void GetSentOrganizationEmailsTest()
        {
            ...
            //int? size = null;
            //string sort = null;
            //var response = instance.GetSentOrganizationEmails(before, inboxId, page, searchFilter, since, size, sort);
            //Assert.IsType<PageSentEmailProjection>(response);
        }
    }
}
