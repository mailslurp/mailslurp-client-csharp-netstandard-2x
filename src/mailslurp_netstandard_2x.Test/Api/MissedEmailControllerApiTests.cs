...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class MissedEmailControllerApiTests : IDisposable
    {
        ...
        public void GetAllMissedEmailsTest()
        {
            ...
            //int? size = null;
            //string sort = null;
            //var response = instance.GetAllMissedEmails(inboxId, page, searchFilter, size, sort);
        ...
        public void GetAllUnknownMissedEmailsTest()
        {
            ...
            //int? size = null;
            //string sort = null;
            //var response = instance.GetAllUnknownMissedEmails(inboxId, page, searchFilter, size, sort);
        ...
        public void WaitForNthMissedEmailTest()
        {
            ...
            //int? index = null;
            //long? timeout = null;
            //var response = instance.WaitForNthMissedEmail(inboxId, index, timeout);
            //Assert.IsType<MissedEmail>(response);
        }
    }
}
