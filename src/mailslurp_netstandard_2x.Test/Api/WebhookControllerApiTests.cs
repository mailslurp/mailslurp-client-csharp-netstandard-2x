...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class WebhookControllerApiTests : IDisposable
    {
        ...
        public void GetAllWebhookResultsTest()
        {
            ...
            //var response = instance.GetAllWebhookResults(before, page, searchFilter, since, size, sort, unseenOnly);
        ...
        public void GetWebhookResultsTest()
        {
            ...
            //string sort = null;
            //bool? unseenOnly = null;
            //var response = instance.GetWebhookResults(webhookId, before, page, searchFilter, since, size, sort, unseenOnly);
            //Assert.IsType<PageWebhookResult>(response);
        }
        ...
        public void GetWebhookResultsUnseenErrorCountTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Guid inboxId = null;
            //var response = instance.GetWebhookResultsUnseenErrorCount(inboxId);
