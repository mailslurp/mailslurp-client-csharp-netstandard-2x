...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class WebhookControllerApiTests : IDisposable
    {
        ...
        public void GetAllWebhookResultsTest()
        {
            ...
            //int? size = null;
            //string sort = null;
            //var response = instance.GetAllWebhookResults(page, searchFilter, size, sort);
        ...
        public void GetAllWebhooksTest()
        {
            ...
            //int? size = null;
            //string sort = null;
            //var response = instance.GetAllWebhooks(page, searchFilter, size, sort);
        ...
        public void GetInboxWebhooksPaginatedTest()
        {
            ...
            //int? size = null;
            //string sort = null;
            //var response = instance.GetInboxWebhooksPaginated(inboxId, page, searchFilter, size, sort);
            //Assert.IsType<PageWebhookProjection>(response);
        }
        ...
        public void GetWebhookResultTest()
        {
            ...
            //Assert.IsType<WebhookResultEntity>(response);
        }
        ...
        public void GetWebhookResultsTest()
        {
            ...
            //int? size = null;
            //string sort = null;
            //var response = instance.GetWebhookResults(webhookId, page, searchFilter, size, sort);
            //Assert.IsType<PageWebhookResult>(response);
        }
