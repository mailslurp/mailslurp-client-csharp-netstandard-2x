...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class AliasControllerApiTests : IDisposable
    {
        ...
        public void GetAliasEmailsTest()
        {
            ...
            //int? size = null;
            //string sort = null;
            //var response = instance.GetAliasEmails(aliasId, before, page, since, size, sort);
        ...
        public void GetAliasThreadsTest()
        {
            ...
            //int? size = null;
            //string sort = null;
            //var response = instance.GetAliasThreads(aliasId, before, page, since, size, sort);
        ...
        public void GetAliasesTest()
        {
            ...
            //int? size = null;
            //string sort = null;
            //var response = instance.GetAliases(before, page, since, size, sort);
