...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class BounceControllerApiTests : IDisposable
    {
        ...
        public void GetBouncedEmailsTest()
        {
            ...
            //int? size = null;
            //string sort = null;
            //var response = instance.GetBouncedEmails(page, size, sort);
        ...
        public void GetBouncedRecipientTest()
        {
            ...
            //Assert.IsType<BounceRecipient>(response);
        }
        ...
        public void GetBouncedRecipientsTest()
        {
            ...
            //int? size = null;
            //string sort = null;
            //var response = instance.GetBouncedRecipients(page, size, sort);
