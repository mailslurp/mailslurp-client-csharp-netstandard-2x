...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class WaitForControllerApiTests : IDisposable
    {
        ...
        public void WaitForEmailCountTest()
        {
            ...
            //var response = instance.WaitForEmailCount(before, count, delay, inboxId, since, sort, timeout, unreadOnly);
            //Assert.IsType<List<EmailPreview>>(response);
        }
        ...
        public void WaitForLatestEmailTest()
        {
            ...
            //long? timeout = null;
            //bool? unreadOnly = null;
            //var response = instance.WaitForLatestEmail(before, delay, inboxId, since, sort, timeout, unreadOnly);
        ...
        public void WaitForMatchingEmailsTest()
        {
            ...
            //long? timeout = null;
            //bool? unreadOnly = null;
            //var response = instance.WaitForMatchingEmails(matchOptions, before, count, delay, inboxId, since, sort, timeout, unreadOnly);
            //Assert.IsType<List<EmailPreview>>(response);
        }
        ...
        public void WaitForMatchingFirstEmailTest()
        {
            ...
            //long? timeout = null;
            //bool? unreadOnly = null;
            //var response = instance.WaitForMatchingFirstEmail(matchOptions, before, delay, inboxId, since, sort, timeout, unreadOnly);
            //Assert.IsType<Email>(response);
        }
        ...
        public void WaitForNthEmailTest()
        {
            ...
            //long? timeout = null;
            //bool? unreadOnly = null;
            //var response = instance.WaitForNthEmail(before, delay, inboxId, index, since, sort, timeout, unreadOnly);
            //Assert.IsType<Email>(response);
        }
    }
}
