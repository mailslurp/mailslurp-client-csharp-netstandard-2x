...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class InboxControllerApiTests : IDisposable
    {
        ...
        public void CreateInboxTest()
        {
            ...
            //var response = instance.CreateInbox(emailAddress, tags, name, description, useDomainPool, favourite, expiresAt, expiresIn, allowTeamAccess, inboxType, virtualInbox, useShortAddress, domainId, domainName);
