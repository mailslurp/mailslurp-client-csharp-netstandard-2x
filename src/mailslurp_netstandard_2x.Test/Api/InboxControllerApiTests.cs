...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class InboxControllerApiTests : IDisposable
    {
        ...
        public void GetEmailsTest()
        {
            ...
            //DateTime? before = null;
            //DateTime? since = null;
            //var response = instance.GetEmails(inboxId, aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit, limit, sortTheResultsByReceivedDateAndDirectionASCOrDESC, retryTimeout, delayTimeout, minCount, unreadOnly, before, since);
