...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class InboxControllerApiTests : IDisposable
    {
        ...
        public void GetEmailsTest()
        {
            ...
            //var response = instance.GetEmails(inboxId, delayTimeout, limit, minCount, retryTimeout, since, size, sort, unreadOnly);
        ...
        public void ListInboxRulesetsTest()
        {
            ...
            //int? size = null;
            //string sort = null;
            //var response = instance.ListInboxRulesets(inboxId, page, searchFilter, size, sort);
        ...
        public void ListInboxTrackingPixelsTest()
        {
            ...
            //int? size = null;
            //string sort = null;
            //var response = instance.ListInboxTrackingPixels(inboxId, page, searchFilter, size, sort);
