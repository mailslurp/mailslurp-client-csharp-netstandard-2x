...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class ApiUserControllerApiTests : IDisposable
    {
        ...
        /// <summary>
        /// Test GetSmtpPassword
        /// </summary>
        [Fact]
        public void GetSmtpPasswordTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.GetSmtpPassword();
            //Assert.IsType<string>(response);
        }

        /// <summary>
        /// Test GetSmtpUsername
        /// </summary>
        [Fact]
        public void GetSmtpUsernameTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.GetSmtpUsername();
            //Assert.IsType<string>(response);
        }
