...
namespace mailslurp_netstandard_2x.Test.Api
{
    ...
    public class MailServerControllerApiTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test 'IsType' MailServerControllerApi
            //Assert.IsType<MailServerControllerApi>(instance);
        }
        ...
        public void DescribeMailServerDomainTest()
        {
            ...
            //Assert.IsType<DescribeMailServerDomainResult>(response);
        }
        ...
        public void GetDnsLookupTest()
        {
            ...
            //Assert.IsType<DNSLookupResults>(response);
        }
        ...
        /// </summary>
        [Fact]
        public void GetDnsLookupsTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //DNSLookupsOptions dNSLookupsOptions = null;
            //var response = instance.GetDnsLookups(dNSLookupsOptions);
            //Assert.IsType<DNSLookupResults>(response);
        }
        ...
        public void GetIpAddressTest()
        {
            ...
            //Assert.IsType<IPAddressResult>(response);
        }
        ...
        public void VerifyEmailAddressTest()
        {
            ...
            //Assert.IsType<EmailVerificationResult>(response);
        }
    }
}
