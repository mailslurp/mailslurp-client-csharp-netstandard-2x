# mailslurp_netstandard_2x.Model.SendEmailOptions
...
**TemplateVariables** | **Dictionary&lt;string, Object&gt;** | Optional map of template variables. Will replace moustache syntax variables in subject and body or template with the associated values if found. | [optional] 
