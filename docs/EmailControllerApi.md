...
# **GetEmailsPaginated**
> PageEmailProjection GetEmailsPaginated (List<Guid> inboxId = null, int? page = null, string searchFilter = null, int? size = null, string sort = null, bool? unreadOnly = null)
...
namespace Example
{
    public class GetEmailsPaginatedExample
    {
        public static void Main()
        {
            ...
            {
                // Get all emails in all inboxes in paginated form. Email API list all.
                PageEmailProjection result = apiInstance.GetEmailsPaginated(inboxId, page, searchFilter, size, sort, unreadOnly);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> PageEmailProjection GetOrganizationEmailsPaginated (List<Guid> inboxId = null, int? page = null, string searchFilter = null, int? size = null, string sort = null, bool? unreadOnly = null)
...
namespace Example
{
    public class GetOrganizationEmailsPaginatedExample
    {
        public static void Main()
        {
            ...
            {
                // Get all organization emails. List team or shared test email accounts
                PageEmailProjection result = apiInstance.GetOrganizationEmailsPaginated(inboxId, page, searchFilter, size, sort, unreadOnly);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
