...
# **GetEmailsPaginated**
> PageEmailProjection GetEmailsPaginated (DateTime? before = null, List<Guid> inboxId = null, int? page = null, string searchFilter = null, DateTime? since = null, int? size = null, string sort = null, bool? unreadOnly = null)
...
namespace Example
{
    public class GetEmailsPaginatedExample
    {
        public static void Main()
        {
            ...
            var searchFilter = searchFilter_example;  // string | Optional search filter. Searches email recipients, sender, subject, email address and ID. Does not search email body (optional)  (default to "false")
            ...
            {
                // Get all emails in all inboxes in paginated form. Email API list all.
                PageEmailProjection result = apiInstance.GetEmailsPaginated(before, inboxId, page, searchFilter, since, size, sort, unreadOnly);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> PageEmailProjection GetOrganizationEmailsPaginated (DateTime? before = null, List<Guid> inboxId = null, int? page = null, string searchFilter = null, DateTime? since = null, int? size = null, string sort = null, bool? unreadOnly = null)
...
namespace Example
{
    public class GetOrganizationEmailsPaginatedExample
    {
        public static void Main()
        {
            ...
            {
                // Get all organization emails. List team or shared test email accounts
                PageEmailProjection result = apiInstance.GetOrganizationEmailsPaginated(before, inboxId, page, searchFilter, since, size, sort, unreadOnly);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> void SendEmailSourceOptional (Guid? inboxId = null, bool? useDomainPool = null, SendEmailOptions sendEmailOptions = null)
...
namespace Example
{
    public class SendEmailSourceOptionalExample
    {
        public static void Main()
        {
            ...
            {
                // Send email
                apiInstance.SendEmailSourceOptional(inboxId, useDomainPool, sendEmailOptions);
            }
            catch (ApiException  e)
            {
