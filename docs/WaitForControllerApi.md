...
> List&lt;EmailPreview&gt; WaitForMatchingEmail (MatchOptions matchOptions, int? count = null, long? delay = null, Guid? inboxId = null, DateTime? since = null, string sort = null, long? timeout = null, bool? unreadOnly = null)
...
namespace Example
{
    public class WaitForMatchingEmailExample
    {
        public static void Main()
        {
            ...
            {
                // Wait or return list of emails that match simple matching patterns
                List<EmailPreview> result = apiInstance.WaitForMatchingEmail(matchOptions, count, delay, inboxId, since, sort, timeout, unreadOnly);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
