...
# **WaitForEmailCount**
> List&lt;EmailPreview&gt; WaitForEmailCount (int? count = null, long? delay = null, Guid? inboxId = null, DateTime? since = null, string sort = null, long? timeout = null, bool? unreadOnly = null)
...
namespace Example
{
    public class WaitForEmailCountExample
    {
        public static void Main()
        {
            ...
            {
                // Wait for and return count number of emails. Hold connection until inbox count matches expected or timeout occurs
                List<EmailPreview> result = apiInstance.WaitForEmailCount(count, delay, inboxId, since, sort, timeout, unreadOnly);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
# **WaitForLatestEmail**
> Email WaitForLatestEmail (long? delay = null, Guid? inboxId = null, DateTime? since = null, string sort = null, long? timeout = null, bool? unreadOnly = null)
...
namespace Example
{
    public class WaitForLatestEmailExample
    {
        public static void Main()
        {
            ...
            {
                // Fetch inbox's latest email or if empty wait for an email to arrive
                Email result = apiInstance.WaitForLatestEmail(delay, inboxId, since, sort, timeout, unreadOnly);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> List&lt;EmailPreview&gt; WaitForMatchingEmails (MatchOptions matchOptions, int? count = null, long? delay = null, Guid? inboxId = null, DateTime? since = null, string sort = null, long? timeout = null, bool? unreadOnly = null)
...
namespace Example
{
    public class WaitForMatchingEmailsExample
    {
        public static void Main()
        {
            ...
            {
                // Wait or return list of emails that match simple matching patterns
                List<EmailPreview> result = apiInstance.WaitForMatchingEmails(matchOptions, count, delay, inboxId, since, sort, timeout, unreadOnly);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> Email WaitForMatchingFirstEmail (MatchOptions matchOptions, long? delay = null, Guid? inboxId = null, DateTime? since = null, string sort = null, long? timeout = null, bool? unreadOnly = null)
...
namespace Example
{
    public class WaitForMatchingFirstEmailExample
    {
        public static void Main()
        {
            ...
            {
                // Wait for or return the first email that matches provided MatchOptions array
                Email result = apiInstance.WaitForMatchingFirstEmail(matchOptions, delay, inboxId, since, sort, timeout, unreadOnly);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
# **WaitForNthEmail**
> Email WaitForNthEmail (long? delay = null, Guid? inboxId = null, int? index = null, DateTime? since = null, string sort = null, long? timeout = null, bool? unreadOnly = null)
...
namespace Example
{
    public class WaitForNthEmailExample
    {
        public static void Main()
        {
            ...
            {
                // Wait for or fetch the email with a given index in the inbox specified. If index doesn't exist waits for it to exist or timeout to occur.
                Email result = apiInstance.WaitForNthEmail(delay, inboxId, index, since, sort, timeout, unreadOnly);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
