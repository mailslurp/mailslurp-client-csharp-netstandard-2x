...
# **GetAllContacts**
> PageContactProjection GetAllContacts (DateTime? before = null, int? page = null, DateTime? since = null, int? size = null, string sort = null)
...
namespace Example
{
    public class GetAllContactsExample
    {
        public static void Main()
        {
            ...
            {
                // Get all contacts
                PageContactProjection result = apiInstance.GetAllContacts(before, page, since, size, sort);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
namespace Example
{
    public class GetContactVCardExample
    {
        public static void Main()
        {
            ...
            {
                // Get contact vCard vcf file
                byte[] result = apiInstance.GetContactVCard(contactId);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
