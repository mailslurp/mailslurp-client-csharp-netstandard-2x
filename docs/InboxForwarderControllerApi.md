...
> PageInboxForwarderEvents GetAllInboxForwarderEvents (int? page = null, int? size = null, string sort = null)
...
namespace Example
{
    public class GetAllInboxForwarderEventsExample
    {
        public static void Main()
        {
            ...
            {
                // Get all inbox forwarder events
                PageInboxForwarderEvents result = apiInstance.GetAllInboxForwarderEvents(page, size, sort);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
{
    // Get all inbox forwarder events
    ApiResponse<PageInboxForwarderEvents> response = apiInstance.GetAllInboxForwarderEventsWithHttpInfo(page, size, sort);
    Debug.Write("Status Code: " + response.StatusCode);
    Debug.Write("Response Headers: " + response.Headers);
    Debug.Write("Response Body: " + response.Data);
}
