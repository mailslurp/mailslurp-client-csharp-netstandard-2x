...
> PageWebhookResult GetAllWebhookResults (DateTime? before = null, int? page = null, string searchFilter = null, DateTime? since = null, int? size = null, string sort = null, bool? unseenOnly = null)
...
namespace Example
{
    public class GetAllWebhookResultsExample
    {
        public static void Main()
        {
            ...
            {
                // Get results for all webhooks
                PageWebhookResult result = apiInstance.GetAllWebhookResults(before, page, searchFilter, since, size, sort, unseenOnly);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
# **GetWebhookResults**
> PageWebhookResult GetWebhookResults (Guid webhookId, DateTime? before = null, int? page = null, string searchFilter = null, DateTime? since = null, int? size = null, string sort = null, bool? unseenOnly = null)
...
namespace Example
{
    public class GetWebhookResultsExample
    {
        public static void Main()
        {
            ...
            {
                // Get a webhook results for a webhook
                PageWebhookResult result = apiInstance.GetWebhookResults(webhookId, before, page, searchFilter, since, size, sort, unseenOnly);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
