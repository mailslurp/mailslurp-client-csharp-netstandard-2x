...
> PageWebhookResult GetAllWebhookResults (int? page = null, int? size = null, string sort = null)
...
namespace Example
{
    public class GetAllWebhookResultsExample
    {
        public static void Main()
        {
            ...
            {
                // Get results for all webhooks
                PageWebhookResult result = apiInstance.GetAllWebhookResults(page, size, sort);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
# **GetWebhookResults**
> PageWebhookResult GetWebhookResults (Guid webhookId, int? page = null, int? size = null, string sort = null)
...
namespace Example
{
    public class GetWebhookResultsExample
    {
        public static void Main()
        {
            ...
            {
                // Get a webhook results for a webhook
                PageWebhookResult result = apiInstance.GetWebhookResults(webhookId, page, size, sort);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
