...
> PageUnknownMissedEmailProjection GetAllUnknownMissedEmails (Guid? inboxId = null, int? page = null, string searchFilter = null, int? size = null, string sort = null)
...
namespace Example
{
    public class GetAllUnknownMissedEmailsExample
    {
        public static void Main()
        {
            ...
            {
                // Get all unknown missed emails in paginated format
                PageUnknownMissedEmailProjection result = apiInstance.GetAllUnknownMissedEmails(inboxId, page, searchFilter, size, sort);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
