...
> MissedEmail WaitForNthMissedEmail (Guid inboxId, long timeout, int? index = null)
...
namespace Example
{
    public class WaitForNthMissedEmailExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new MissedEmailControllerApi(config);
            var inboxId = new Guid(); // Guid | Optional inbox ID filter
            var timeout = 789;  // long | Optional timeout milliseconds
            ...
            {
                // Wait for Nth missed email
                MissedEmail result = apiInstance.WaitForNthMissedEmail(inboxId, timeout, index);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxId** | [**Guid**](Guid)| Optional inbox ID filter | 
 **timeout** | **long**| Optional timeout milliseconds | 
