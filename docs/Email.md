# mailslurp_netstandard_2x.Model.Email
...
**DomainId** | **Guid?** | ID of the domain that received the email | [optional] 
...
**HeadersMap** | **Dictionary&lt;string, List&lt;string&gt;&gt;** | Multi-value map of SMTP headers attached to email | [optional] 
