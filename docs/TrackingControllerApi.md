...
> PageTrackingPixelProjection GetAllTrackingPixels (int? page = null, string searchFilter = null, int? size = null, string sort = null)
...
namespace Example
{
    public class GetAllTrackingPixelsExample
    {
        public static void Main()
        {
            ...
            {
                // Get tracking pixels
                PageTrackingPixelProjection result = apiInstance.GetAllTrackingPixels(page, searchFilter, size, sort);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
