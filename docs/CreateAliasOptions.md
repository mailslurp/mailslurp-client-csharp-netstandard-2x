# mailslurp_netstandard_2x.Model.CreateAliasOptions
...
**DomainId** | **Guid?** | Custom domain ID to use when generating alias email addresses | [optional] 
**VerifyEmailAddress** | **bool?** | Whether to verify the masked email address exists before sending an email to it | [optional] 
