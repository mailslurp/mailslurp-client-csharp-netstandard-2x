# mailslurp_netstandard_2x.Api.ApiUserControllerApi
...
namespace Example
{
    public class GetSmtpPasswordExample
    {
        public static void Main()
        {
            ...
            try
            {
                string result = apiInstance.GetSmtpPassword();
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling ApiUserControllerApi.GetSmtpPassword: " + e.Message );
...
namespace Example
{
    public class GetSmtpUsernameExample
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            try
            {
                string result = apiInstance.GetSmtpUsername();
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling ApiUserControllerApi.GetSmtpUsername: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
