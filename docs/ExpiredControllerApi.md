# mailslurp_netstandard_2x.Api.ExpiredControllerApi
...
> ExpiredInboxDto GetExpiredInboxRecord (Guid iDOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId)
...
namespace Example
{
    public class GetExpiredInboxRecordExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new ExpiredControllerApi(config);
            var iDOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId = new Guid(); // Guid | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **iDOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId** | [**Guid**](Guid)|  | 
