...
> PageOrganizationInboxProjection GetOrganizationInboxes (int? page = null, int? size = null, string sort = null)
...
namespace Example
{
    public class GetOrganizationInboxesExample
    {
        public static void Main()
        {
            ...
            {
                // List Organization Inboxes Paginated
                PageOrganizationInboxProjection result = apiInstance.GetOrganizationInboxes(page, size, sort);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
