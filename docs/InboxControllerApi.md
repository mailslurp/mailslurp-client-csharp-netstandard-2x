...
# **GetAllInboxes**
> PageInboxProjection GetAllInboxes (DateTime? before = null, bool? favourite = null, int? page = null, string search = null, DateTime? since = null, int? size = null, string sort = null, string tag = null, bool? teamAccess = null)
...
namespace Example
{
    public class GetAllInboxesExample
    {
        public static void Main()
        {
            ...
            var teamAccess = true;  // bool? | DEPRECATED. Optionally filter by team access. (optional)  (default to false)
 ...
 **teamAccess** | **bool?**| DEPRECATED. Optionally filter by team access. | [optional] [default to false]
...
<a name="getemails"></a>
# **GetEmails**
> List&lt;EmailPreview&gt; GetEmails (Guid inboxId, DateTime? before = null, long? delayTimeout = null, int? limit = null, long? minCount = null, long? retryTimeout = null, DateTime? since = null, int? size = null, string sort = null, bool? unreadOnly = null)
...
namespace Example
{
    public class GetEmailsExample
    {
        public static void Main()
        {
            ...
            var delayTimeout = 789;  // long? | delayTimeout (optional) 
            ...
            var unreadOnly = true;  // bool? | unreadOnly (optional) 
 ...
 **unreadOnly** | **bool?**| unreadOnly | [optional] 
...
> PageEmailPreview GetInboxEmailsPaginated (Guid inboxId, DateTime? before = null, int? page = null, DateTime? since = null, int? size = null, string sort = null)
...
# **GetInboxSentEmails**
> PageSentEmailProjection GetInboxSentEmails (Guid inboxId, DateTime? before = null, int? page = null, string searchFilter = null, DateTime? since = null, int? size = null, string sort = null)
...
<a name="getinboxes"></a>
# **GetInboxes**
> List&lt;Inbox&gt; GetInboxes (DateTime? before = null, DateTime? since = null, int? size = null, string sort = null)
...
> PageOrganizationInboxProjection GetOrganizationInboxes (DateTime? before = null, int? page = null, string searchFilter = null, DateTime? since = null, int? size = null, string sort = null)
...
# **ListInboxRulesets**
> PageInboxRulesetDto ListInboxRulesets (Guid inboxId, DateTime? before = null, int? page = null, string searchFilter = null, DateTime? since = null, int? size = null, string sort = null)
...
> PageTrackingPixelProjection ListInboxTrackingPixels (Guid inboxId, DateTime? before = null, int? page = null, string searchFilter = null, DateTime? since = null, int? size = null, string sort = null)
