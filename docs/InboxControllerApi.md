# mailslurp_netstandard_2x.Api.InboxControllerApi
...
# **CreateInbox**
> InboxDto CreateInbox (string  = null, List<string> tagsThatInboxHasBeenTaggedWithTagsCanBeAddedToInboxesToGroupDifferentInboxesWithinAnAccountYouCanAlsoSearchForInboxesByTagInTheDashboardUI = null, string optionalNameOfTheInboxDisplayedInTheDashboardForEasierSearchAndUsedAsTheSenderNameWhenSendingEmails = null, string optionalDescriptionOfTheInboxForLabellingPurposesIsShownInTheDashboardAndCanBeUsedWith = null, bool?  = null, bool? isTheInboxAFavoriteMarkingAnInboxAsAFavoriteIsTypicallyDoneInTheDashboardForQuickAccessOrFiltering = null, DateTime?  = null, long? numberOfMillisecondsThatInboxShouldExistFor = null, bool? dEPRECATEDTeamAccessIsAlwaysTrueGrantTeamAccessToThisInboxAndTheEmailsThatBelongToItForTeamMembersOfYourOrganization = null, string  = null)
...
namespace Example
{
    public class CreateInboxExample
    {
        public static void Main()
        {
            ...
            var  = _example;  // string |  (optional) 
            var tagsThatInboxHasBeenTaggedWithTagsCanBeAddedToInboxesToGroupDifferentInboxesWithinAnAccountYouCanAlsoSearchForInboxesByTagInTheDashboardUI = new List<string>(); // List<string> |  (optional) 
            var optionalNameOfTheInboxDisplayedInTheDashboardForEasierSearchAndUsedAsTheSenderNameWhenSendingEmails = optionalNameOfTheInboxDisplayedInTheDashboardForEasierSearchAndUsedAsTheSenderNameWhenSendingEmails_example;  // string |  (optional) 
            var optionalDescriptionOfTheInboxForLabellingPurposesIsShownInTheDashboardAndCanBeUsedWith = optionalDescriptionOfTheInboxForLabellingPurposesIsShownInTheDashboardAndCanBeUsedWith_example;  // string |  (optional) 
            var  = true;  // bool? |  (optional) 
            var isTheInboxAFavoriteMarkingAnInboxAsAFavoriteIsTypicallyDoneInTheDashboardForQuickAccessOrFiltering = true;  // bool? |  (optional) 
            var  = 2013-10-20T19:20:30+01:00;  // DateTime? |  (optional) 
            var numberOfMillisecondsThatInboxShouldExistFor = 789;  // long? |  (optional) 
            var dEPRECATEDTeamAccessIsAlwaysTrueGrantTeamAccessToThisInboxAndTheEmailsThatBelongToItForTeamMembersOfYourOrganization = true;  // bool? |  (optional) 
            var  = _example;  // string |  (optional) 

            try
            {
                // Create an inbox email address. An inbox has a real email address and can send and receive emails. Inboxes can be either `SMTP` or `HTTP` inboxes.
                InboxDto result = apiInstance.CreateInbox(, tagsThatInboxHasBeenTaggedWithTagsCanBeAddedToInboxesToGroupDifferentInboxesWithinAnAccountYouCanAlsoSearchForInboxesByTagInTheDashboardUI, optionalNameOfTheInboxDisplayedInTheDashboardForEasierSearchAndUsedAsTheSenderNameWhenSendingEmails, optionalDescriptionOfTheInboxForLabellingPurposesIsShownInTheDashboardAndCanBeUsedWith, , isTheInboxAFavoriteMarkingAnInboxAsAFavoriteIsTypicallyDoneInTheDashboardForQuickAccessOrFiltering, , numberOfMillisecondsThatInboxShouldExistFor, dEPRECATEDTeamAccessIsAlwaysTrueGrantTeamAccessToThisInboxAndTheEmailsThatBelongToItForTeamMembersOfYourOrganization, );
...
# **GetAllInboxes**
> PageInboxProjection GetAllInboxes (int? page = null, int? size = null, string sort = null, bool? favourite = null, string search = null, string tag = null, bool? dEPRECATEDOptionallyFilterByTeamAccess = null, DateTime? since = null, DateTime? before = null)
...
namespace Example
{
    public class GetAllInboxesExample
    {
        public static void Main()
        {
            ...
            var dEPRECATEDOptionallyFilterByTeamAccess = true;  // bool? |  (optional) 
...
<a name="getemails"></a>
# **GetEmails**
> List&lt;EmailPreview&gt; GetEmails (Guid idOfInboxThatEmailsBelongsTo, int? aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit = null, int? limit = null, string sortTheResultsByReceivedDateAndDirectionASCOrDESC = null, long? retryTimeout = null, long? delayTimeout = null, long? minCount = null, bool? unreadOnly = null, DateTime? excludeEmailsReceivedAfterThisISO8601DateTime = null, DateTime? excludeEmailsReceivedBeforeThisISO8601DateTime = null)
...
namespace Example
{
    public class GetEmailsExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new InboxControllerApi(config);
            var idOfInboxThatEmailsBelongsTo = new Guid(); // Guid | 
            var aliasForLimitAssessedFirstBeforeAssessingAnyPassedLimit = 56;  // int? |  (optional) 
            ...
            var sortTheResultsByReceivedDateAndDirectionASCOrDESC = sortTheResultsByReceivedDateAndDirectionASCOrDESC_example;  // string |  (optional) 
            ...
            var excludeEmailsReceivedAfterThisISO8601DateTime = 2013-10-20T19:20:30+01:00;  // DateTime? |  (optional) 
            var excludeEmailsReceivedBeforeThisISO8601DateTime = 2013-10-20T19:20:30+01:00;  // DateTime? |  (optional) 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **idOfInboxThatEmailsBelongsTo** | [**Guid**](Guid)|  | 
...
# **GetInboxEmailCount**
> CountDto GetInboxEmailCount (Guid idOfInboxThatEmailsBelongsTo)
...
> PageEmailPreview GetInboxEmailsPaginated (Guid idOfInboxThatEmailsBelongsTo, int? page = null, int? size = null, string sort = null, DateTime? since = null, DateTime? before = null)
...
# **GetInboxSentEmails**
> PageSentEmailProjection GetInboxSentEmails (Guid inboxId, int? page = null, int? optionalPageSizeInInboxSentEmailListPagination = null, string sort = null, string searchFilter = null, DateTime? since = null, DateTime? before = null)
...
namespace Example
{
    public class GetInboxSentEmailsExample
    {
        public static void Main()
        {
            ...
            var optionalPageSizeInInboxSentEmailListPagination = 56;  // int? |  (optional)  (default to 20)
            var sort = sort_example;  // string | Optional createdAt sort direction ASC or DESC (optional)  (default to ASC)
...
> PageTrackingPixelProjection ListInboxTrackingPixels (Guid inboxId, int? page = null, int? optionalPageSizeInInboxTrackingPixelListPagination = null, string sort = null, string searchFilter = null, DateTime? since = null, DateTime? before = null)
...
namespace Example
{
    public class ListInboxTrackingPixelsExample
    {
        public static void Main()
        {
            ...
            var optionalPageSizeInInboxTrackingPixelListPagination = 56;  // int? |  (optional)  (default to 20)
            var sort = sort_example;  // string | Optional createdAt sort direction ASC or DESC (optional)  (default to ASC)
            var searchFilter = searchFilter_example;  // string | Optional search filter (optional) 
            var since = 2013-10-20T19:20:30+01:00;  // DateTime? | Optional filter by created after given date time (optional) 
            var before = 2013-10-20T19:20:30+01:00;  // DateTime? | Optional filter by created before given date time (optional) 
...
<a name="sendemail"></a>
# **SendEmail**
> void SendEmail (Guid iDOfTheInboxYouWantToSendTheEmailFrom, SendEmailOptions sendEmailOptions)
...
namespace Example
{
    public class SendEmailExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new InboxControllerApi(config);
            var iDOfTheInboxYouWantToSendTheEmailFrom = new Guid(); // Guid | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **iDOfTheInboxYouWantToSendTheEmailFrom** | [**Guid**](Guid)|  | 
...
# **SendEmailAndConfirm**
> SentEmailDto SendEmailAndConfirm (Guid iDOfTheInboxYouWantToSendTheEmailFrom, SendEmailOptions sendEmailOptions)
