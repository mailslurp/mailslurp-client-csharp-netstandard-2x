...
<a name="getemails"></a>
# **GetEmails**
> List&lt;EmailPreview&gt; GetEmails (Guid inboxId, long? delayTimeout = null, int? limit = null, long? minCount = null, long? retryTimeout = null, DateTime? since = null, int? size = null, string sort = null, bool? unreadOnly = null)
...
namespace Example
{
    public class GetEmailsExample
    {
        public static void Main()
        {
            ...
            {
                // Get emails in an Inbox. This method is not idempotent as it allows retries and waits if you want certain conditions to be met before returning. For simple listing and sorting of known emails use the email controller instead.
                List<EmailPreview> result = apiInstance.GetEmails(inboxId, delayTimeout, limit, minCount, retryTimeout, since, size, sort, unreadOnly);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
