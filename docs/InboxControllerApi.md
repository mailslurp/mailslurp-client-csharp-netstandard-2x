...
# **CreateInboxRuleset**
> void CreateInboxRuleset (Guid inboxId, CreateInboxRulesetOptions createInboxRulesetOptions)
...
namespace Example
{
    public class CreateInboxRulesetExample
    {
        public static void Main()
        {
            ...
            {
                // Create an inbox ruleset
                apiInstance.CreateInboxRuleset(inboxId, createInboxRulesetOptions);
            }
            catch (ApiException  e)
            {
...
# **ListInboxRulesets**
> void ListInboxRulesets (Guid inboxId, int? page = null, string searchFilter = null, int? size = null, string sort = null)
...
namespace Example
{
    public class ListInboxRulesetsExample
    {
        public static void Main()
        {
            ...
            {
                // List inbox rulesets
                apiInstance.ListInboxRulesets(inboxId, page, searchFilter, size, sort);
            }
            catch (ApiException  e)
            {
