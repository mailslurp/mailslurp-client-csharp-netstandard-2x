...
namespace Example
{
    public class GetBouncedEmail1Example
    {
        public static void Main()
        {
            Configuration config = new Configuration();
            ...
            {
                Debug.Print("Exception when calling BounceControllerApi.GetBouncedEmail1: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
# **GetBouncedEmails**
> void GetBouncedEmails (int? page = null, int? size = null, string sort = null)
...
> void GetBouncedRecipients (int? page = null, int? size = null, string sort = null)
