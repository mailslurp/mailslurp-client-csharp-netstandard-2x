...
> InboxDto CreateNewEmailAddress (bool? allowTeamAccess = null, bool? useDomainPool = null, DateTime? expiresAt = null, long? expiresIn = null, string emailAddress = null, string inboxType = null, string description = null, string name = null, List<string> tags = null, bool? favourite = null)
...
> InboxDto CreateNewEmailAddress1 (bool? allowTeamAccess = null, bool? useDomainPool = null, DateTime? expiresAt = null, long? expiresIn = null, string emailAddress = null, string inboxType = null, string description = null, string name = null, List<string> tags = null, bool? favourite = null)
...
namespace Example
{
    public class CreateNewEmailAddress1Example
    {
        public static void Main()
        {
            ...
            {
                // Create new random inbox
                InboxDto result = apiInstance.CreateNewEmailAddress1(allowTeamAccess, useDomainPool, expiresAt, expiresIn, emailAddress, inboxType, description, name, tags, favourite);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
