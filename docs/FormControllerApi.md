# mailslurp_netstandard_2x.Api.FormControllerApi
...
<a name="submitform"></a>
# **SubmitForm**
> string SubmitForm (string emailAddress = null, string redirectTo = null, string spamCheck = null, string subject = null, string successMessage = null, string to = null, string otherParameters = null)
...
namespace Example
{
    public class SubmitFormExample
    {
        public static void Main()
        {
            ...
            var to = to_example;  // string | The email address that submitted form should be sent to. (optional) 
