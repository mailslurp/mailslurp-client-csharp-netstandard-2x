...
> List&lt;byte[]&gt; DownloadAttachmentAsBytes (string attachmentId)
...
namespace Example
{
    public class DownloadAttachmentAsBytesExample
    {
        public static void Main()
        {
            ...
            {
                // Download attachments. Get email attachment bytes. If you have trouble with byte responses try the `downloadAttachmentBase64` response endpoints.
                List<byte[]> result = apiInstance.DownloadAttachmentAsBytes(attachmentId);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
# **GetAttachments1**
> PageAttachmentEntity GetAttachments1 (int? page = null, int? size = null, string sort = null, string fileNameFilter = null, DateTime? since = null, DateTime? before = null)
...
namespace Example
{
    public class GetAttachments1Example
    {
        public static void Main()
        {
            ...
            {
                // Get email attachments
                PageAttachmentEntity result = apiInstance.GetAttachments1(page, size, sort, fileNameFilter, since, before);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
                Debug.Print("Exception when calling AttachmentControllerApi.GetAttachments1: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
> List&lt;string&gt; UploadAttachmentBytes (List<byte[]> requestBody, string contentType = null, string filename = null)
...
namespace Example
{
    public class UploadAttachmentBytesExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new AttachmentControllerApi(config);
            var requestBody = new List<byte[]>(); // List<byte[]> | 
            ...
            {
                // Upload an attachment for sending using file byte stream input octet stream. Returns an array whose first element is the ID of the uploaded attachment.
                List<string> result = apiInstance.UploadAttachmentBytes(requestBody, contentType, filename);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
