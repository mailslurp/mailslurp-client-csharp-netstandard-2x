...
# **GetAllGroups**
> PageGroupProjection GetAllGroups (DateTime? before = null, int? page = null, DateTime? since = null, int? size = null, string sort = null)
...
namespace Example
{
    public class GetAllGroupsExample
    {
        public static void Main()
        {
            ...
            {
                // Get all Contact Groups in paginated format
                PageGroupProjection result = apiInstance.GetAllGroups(before, page, since, size, sort);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
...
> PageContactProjection GetGroupWithContactsPaginated (Guid groupId, DateTime? before = null, int? page = null, DateTime? since = null, int? size = null, string sort = null)
...
namespace Example
{
    public class GetGroupWithContactsPaginatedExample
    {
        public static void Main()
        {
            ...
            {
                // Get group and paginated contacts belonging to it
                PageContactProjection result = apiInstance.GetGroupWithContactsPaginated(groupId, before, page, since, size, sort);
                Debug.WriteLine(result);
            }
            catch (ApiException  e)
            {
