# mailslurp_netstandard_2x.Api.UserControllerApi
...
namespace Example
{
    public class GetJsonPropertyAsStringExample
    {
        public static void Main()
        {
            ...
            var apiInstance = new UserControllerApi(config);
            ...
            {
                Debug.Print("Exception when calling UserControllerApi.GetJsonPropertyAsString: " + e.Message);
...
{
    Debug.Print("Exception when calling UserControllerApi.GetJsonPropertyAsStringWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
...
namespace Example
{
    public class GetUserInfoExample
    {
        public static void Main()
        {
            ...
            {
                Debug.Print("Exception when calling UserControllerApi.GetUserInfo: " + e.Message);
                Debug.Print("Status Code: " + e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
...
{
    Debug.Print("Exception when calling UserControllerApi.GetUserInfoWithHttpInfo: " + e.Message);
    Debug.Print("Status Code: " + e.ErrorCode);
    Debug.Print(e.StackTrace);
}
```
